...
contract DeployArbConfigManagerForExitingChains is Script {
    ...
    function setup() public {
        chainConfigs[0] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/nYkJi2K0LszDqj8jzWY-rMJmK9ugf0oF",
        ...
        chainConfigs[1] = ChainConfig({
            ...
            initialAppchainOwner: 0x9a37E57d177c5Ff8817B55da36F2A2b3532CDE3F,
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/K6cAUXQhrUT3KJPd9a-glciOF5ZA_F8Y",
        ...
        chainConfigs[2] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/N0h_vjT4BYXwZiVztRrkrosYQJ3BrjhZ",
        ...
        chainConfigs[3] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/JUf91yTBjhebYjt0fiSCA6P7pHfBW9Qh",
        ...
        chainConfigs[4] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/UDCvUkvgFJoWhw1iHzv5d6boyAUkiEXm",
        ...
        chainConfigs[5] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/p30cSnfOl2hUk4ttKlu3Oc7kB2ISbfDx",
        ...
        chainConfigs[6] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/DP0DpJsF06Wesj-qSRJo-LcaITq4Zdj8",
        ...
        chainConfigs[7] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/zF2VPnW8iE9qkK2gg-_l4U5PFRotapkP",
        ...
        chainConfigs[8] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/sZNwGOfKliBBRgkUYXpt6oBVu4IHGMj7",
        ...
        chainConfigs[9] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/HHFTTDrDallGO3g629tEkWmCsLkIpas4",
        ...
        chainConfigs[10] = ChainConfig({
            ...
            sequencingChainRpcUrl: "https://syndicate-exo.g.alchemy.com/v2/z5h0zUXmyg_xtPUQgYxBCUtw97GBtGzD",

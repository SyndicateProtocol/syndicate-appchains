...
contract StorageUpgradeTest is Test {
    ...
    function testStoragePreservationAfterUpgrade() public {
        ...
        assertEq(syndicateV2.getEmissionsReceiver(), originalData.emissionsReceiver, "emissionsReceiver should be preserved");
        assertEq(syndicateV2.factory(), originalData.factory, "factory should be preserved");
        assertEq(syndicateV2.allowGasTrackingBanOnUpgrade(), originalData.allowGasTrackingBanOnUpgrade, "allowGasTrackingBanOnUpgrade should be preserved");
        ...
        assertEq(syndicateV2.gasTrackingEnabled(), originalData.gasTrackingEnabled, "gasTrackingEnabled should be preserved");
    ...
    function testNoStorageCollisions() public {
        ...
        assertTrue(syndicateV2.allowGasTrackingBanOnUpgrade(), "V1 storage should not be affected by V2 storage modifications");

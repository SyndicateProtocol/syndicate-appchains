...
contract SyndicateSequencingChainWithDecayingPriorityTest is SyndicateSequencingChainWithDecayingPriorityTestSetUp {
    ...
    function testProcessTransactionRequireAllFailure() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(RequireAndModule.AndPermissionCheckFailed.selector, mockRequireAllAddr, address(this), testData2)
        );
    ...
    function testProcessTransactionRequireAnyFailure() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(RequireOrModule.AllOrPermissionChecksFailed.selector, address(this), testData2));

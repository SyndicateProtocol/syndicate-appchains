...
See the [wrapper's documentation](`IERC721ErrorsInstance`) for more details.*/
    ...
    >(
        ...
        IERC721ErrorsInstance::<T, P, N>::new(address, provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC721ErrorsInstance<T, P, N> {
        #[inline]
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC721ErrorsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC721ErrorsInstance<T, P, N> {

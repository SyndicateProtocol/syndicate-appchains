...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC1967UpgradeEvents {
        const NAME: &'static str = "ERC1967UpgradeEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC1967UpgradeEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ERC1967Upgrade`](self) contract instance.

See the [wrapper's documentation](`ERC1967UpgradeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC1967UpgradeInstance<T, P, N> {
        ERC1967UpgradeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC1967UpgradeInstance<T, P, N>>,
    > {
        ERC1967UpgradeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ERC1967UpgradeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC1967Upgrade`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC1967Upgrade`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC1967UpgradeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC1967UpgradeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC1967UpgradeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC1967UpgradeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ERC1967UpgradeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC1967UpgradeInstance<T, P, N> {

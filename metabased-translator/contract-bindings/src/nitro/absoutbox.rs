...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for AbsOutboxCalls {
        const NAME: &'static str = "AbsOutboxCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<AbsOutboxCalls>] = &[
                {
                    fn calculateMerkleRoot(
                        ...
                        <calculateMerkleRootCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::calculateMerkleRoot)
                    }
                    calculateMerkleRoot
                },
                {
                    fn executeTransaction(
                        ...
                        <executeTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::executeTransaction)
                    }
                    executeTransaction
                },
                {
                    fn l2ToL1BatchNum(
                        ...
                        <l2ToL1BatchNumCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1BatchNum)
                    }
                    l2ToL1BatchNum
                },
                {
                    fn executeTransactionSimulation(
                        ...
                        <executeTransactionSimulationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::executeTransactionSimulation)
                    }
                ...
                },
                {
                    fn l2ToL1Block(
                        ...
                        <l2ToL1BlockCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1Block)
                    }
                    l2ToL1Block
                },
                {
                ...
                },
                {
                    fn updateRollupAddress(
                        ...
                        <updateRollupAddressCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::updateRollupAddress)
                    }
                    updateRollupAddress
                },
                {
                    fn l2ToL1OutputId(
                        ...
                        <l2ToL1OutputIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1OutputId)
                    }
                    l2ToL1OutputId
                },
                {
                    fn l2ToL1Sender(
                        ...
                        <l2ToL1SenderCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1Sender)
                    }
                    l2ToL1Sender
                },
                {
                    fn l2ToL1EthBlock(
                        ...
                        <l2ToL1EthBlockCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1EthBlock)
                    }
                    l2ToL1EthBlock
                },
                {
                    fn postUpgradeInit(
                        ...
                        <postUpgradeInitCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::postUpgradeInit)
                    }
                    postUpgradeInit
                },
                {
                    fn calculateItemHash(
                        ...
                        <calculateItemHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::calculateItemHash)
                    }
                    calculateItemHash
                },
                {
                    fn updateSendRoot(
                        ...
                        <updateSendRootCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::updateSendRoot)
                    }
                    updateSendRoot
                },
                {
                ...
                },
                {
                    fn l2ToL1Timestamp(
                        ...
                        <l2ToL1TimestampCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::l2ToL1Timestamp)
                    }
                    l2ToL1Timestamp
                },
                {
                ...
                },
                {
                    fn OUTBOX_VERSION(
                        ...
                        <OUTBOX_VERSIONCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AbsOutboxCalls::OUTBOX_VERSION)
                    }
                    OUTBOX_VERSION
                },
                {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for AbsOutboxErrors {
        const NAME: &'static str = "AbsOutboxErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<AbsOutboxErrors>] = &[
                {
                    fn PathNotMinimal(
                        data: &[u8],
                        validate: bool,
                        ...
                        <PathNotMinimal as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::PathNotMinimal)
                    }
                    PathNotMinimal
                },
                {
                    fn SimulationOnlyEntrypoint(
                        ...
                        <SimulationOnlyEntrypoint as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::SimulationOnlyEntrypoint)
                    }
                ...
                },
                {
                    fn HadZeroInit(
                        ...
                        <HadZeroInit as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::HadZeroInit)
                    }
                    HadZeroInit
                },
                {
                ...
                },
                {
                    fn BridgeCallFailed(
                        ...
                        <BridgeCallFailed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::BridgeCallFailed)
                    }
                    BridgeCallFailed
                },
                {
                ...
                },
                {
                    fn UnknownRoot(
                        ...
                        <UnknownRoot as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::UnknownRoot)
                    }
                    UnknownRoot
                },
                {
                    fn AlreadySpent(
                        ...
                        <AlreadySpent as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::AlreadySpent)
                    }
                    AlreadySpent
                },
                {
                    fn ProofTooLong(
                        ...
                        <ProofTooLong as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::ProofTooLong)
                    }
                    ProofTooLong
                },
                {
                    fn RollupNotChanged(
                        ...
                        <RollupNotChanged as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::RollupNotChanged)
                    }
                    RollupNotChanged
                },
                {
                    fn BadPostUpgradeInit(
                        ...
                        <BadPostUpgradeInit as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::BadPostUpgradeInit)
                    }
                    BadPostUpgradeInit
                },
                {
                    fn AlreadyInit(
                        ...
                        <AlreadyInit as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::AlreadyInit)
                    }
                    AlreadyInit
                },
                {
                    fn MerkleProofTooLong(
                        ...
                        <MerkleProofTooLong as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(AbsOutboxErrors::MerkleProofTooLong)
                    }
                    MerkleProofTooLong
                },
            ];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for AbsOutboxEvents {
        const NAME: &'static str = "AbsOutboxEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for AbsOutboxEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`AbsOutbox`](self) contract instance.

See the [wrapper's documentation](`AbsOutboxInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> AbsOutboxInstance<T, P, N> {
        AbsOutboxInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<AbsOutboxInstance<T, P, N>>,
    > {
        AbsOutboxInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        AbsOutboxInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`AbsOutbox`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`AbsOutbox`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct AbsOutboxInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for AbsOutboxInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("AbsOutboxInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<AbsOutboxInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> AbsOutboxInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> AbsOutboxInstance<T, P, N> {
            AbsOutboxInstance {

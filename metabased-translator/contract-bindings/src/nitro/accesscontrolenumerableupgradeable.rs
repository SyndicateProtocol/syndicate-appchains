...
See the [wrapper's documentation](`AccessControlEnumerableUpgradeableInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> AccessControlEnumerableUpgradeableInstance<T, P, N> {
        AccessControlEnumerableUpgradeableInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        >,
    > {
        AccessControlEnumerableUpgradeableInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        AccessControlEnumerableUpgradeableInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    for AccessControlEnumerableUpgradeableInstance<T, P, N> {
        #[inline]

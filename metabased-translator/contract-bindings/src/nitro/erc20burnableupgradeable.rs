...
```solidity
interface ERC20BurnableUpgradeable {
...
```*/
    ...
    ///Container for all the [`ERC20BurnableUpgradeable`](self) function calls.
    pub enum ERC20BurnableUpgradeableCalls {
    ...
    #[automatically_derived]
    impl ERC20BurnableUpgradeableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20BurnableUpgradeableCalls {
        const NAME: &'static str = "ERC20BurnableUpgradeableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ERC20BurnableUpgradeableCalls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                        ...
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::name)
                    }
                    name
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::decimals)
                    }
                    decimals
                },
                {
                    fn increaseAllowance(
                        ...
                        <increaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::increaseAllowance)
                    }
                    increaseAllowance
                },
                {
                    fn burn(
                        ...
                        <burnCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::burn)
                    }
                    burn
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn burnFrom(
                        ...
                        <burnFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::burnFrom)
                    }
                    burnFrom
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::symbol)
                    }
                    symbol
                },
                {
                    fn decreaseAllowance(
                        ...
                        <decreaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::decreaseAllowance)
                    }
                    decreaseAllowance
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::transfer)
                    }
                    transfer
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20BurnableUpgradeableCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`ERC20BurnableUpgradeable`](self) events.
    pub enum ERC20BurnableUpgradeableEvents {
        Approval(Approval),
        Initialized(Initialized),
        Transfer(Transfer),
    }
    #[automatically_derived]
    impl ERC20BurnableUpgradeableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC20BurnableUpgradeableEvents {
        const NAME: &'static str = "ERC20BurnableUpgradeableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC20BurnableUpgradeableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`ERC20BurnableUpgradeable`](self) contract instance.

See the [wrapper's documentation](`ERC20BurnableUpgradeableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC20BurnableUpgradeableInstance<T, P, N> {
        ERC20BurnableUpgradeableInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC20BurnableUpgradeableInstance<T, P, N>>,
    > {
        ERC20BurnableUpgradeableInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ERC20BurnableUpgradeableInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC20BurnableUpgradeable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC20BurnableUpgradeable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC20BurnableUpgradeableInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC20BurnableUpgradeableInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20BurnableUpgradeableInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC20BurnableUpgradeableInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ERC20BurnableUpgradeableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC20BurnableUpgradeableInstance<T, P, N> {

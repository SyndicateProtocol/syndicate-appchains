...
```*/
    ...
    ///Container for all the [`IEthBridge`](self) function calls.
    pub enum IEthBridgeCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEthBridgeCalls {
        const NAME: &'static str = "IEthBridgeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IEthBridgeCalls>] = &[
                {
                    fn sequencerMessageCount(
                        ...
                        <sequencerMessageCountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::sequencerMessageCount)
                    }
                ...
                },
                {
                    fn sequencerInboxAccs(
                        ...
                        <sequencerInboxAccsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::sequencerInboxAccs)
                    }
                    sequencerInboxAccs
                },
                {
                    fn allowedOutboxes(
                        ...
                        <allowedOutboxesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::allowedOutboxes)
                    }
                    allowedOutboxes
                },
                {
                    fn setDelayedInbox(
                        ...
                        <setDelayedInboxCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::setDelayedInbox)
                    }
                    setDelayedInbox
                },
                {
                    fn setSequencerInbox(
                        ...
                        <setSequencerInboxCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::setSequencerInbox)
                    }
                    setSequencerInbox
                },
                {
                    fn sequencerReportedSubMessageCount(
                        ...
                        <sequencerReportedSubMessageCountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::sequencerReportedSubMessageCount)
                    }
                ...
                },
                {
                    fn submitBatchSpendingReport(
                        ...
                        <submitBatchSpendingReportCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::submitBatchSpendingReport)
                    }
                ...
                },
                {
                    fn enqueueSequencerMessage(
                        ...
                        <enqueueSequencerMessageCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::enqueueSequencerMessage)
                    }
                ...
                },
                {
                    fn enqueueDelayedMessage(
                        ...
                        <enqueueDelayedMessageCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::enqueueDelayedMessage)
                    }
                ...
                },
                {
                    fn updateRollupAddress(
                        ...
                        <updateRollupAddressCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::updateRollupAddress)
                    }
                    updateRollupAddress
                },
                {
                    fn allowedOutboxList(
                        ...
                        <allowedOutboxListCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::allowedOutboxList)
                    }
                    allowedOutboxList
                },
                {
                    fn executeCall(
                        ...
                        <executeCallCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::executeCall)
                    }
                    executeCall
                },
                {
                    fn activeOutbox(
                        ...
                        <activeOutboxCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::activeOutbox)
                    }
                    activeOutbox
                },
                {
                    fn allowedDelayedInboxes(
                        ...
                        <allowedDelayedInboxesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::allowedDelayedInboxes)
                    }
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::initialize)
                    }
                    initialize
                },
                {
                ...
                },
                {
                    fn delayedInboxAccs(
                        ...
                        <delayedInboxAccsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::delayedInboxAccs)
                    }
                    delayedInboxAccs
                },
                {
                    fn allowedDelayedInboxList(
                        ...
                        <allowedDelayedInboxListCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::allowedDelayedInboxList)
                    }
                ...
                },
                {
                    fn delayedMessageCount(
                        ...
                        <delayedMessageCountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::delayedMessageCount)
                    }
                    delayedMessageCount
                },
                {
                    fn sequencerInbox(
                        ...
                        <sequencerInboxCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEthBridgeCalls::sequencerInbox)
                    }
                    sequencerInbox
                },
            ];
    ...
    ///Container for all the [`IEthBridge`](self) events.
    pub enum IEthBridgeEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IEthBridgeEvents {
        const NAME: &'static str = "IEthBridgeEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IEthBridgeEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IEthBridge`](self) contract instance.

See the [wrapper's documentation](`IEthBridgeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IEthBridgeInstance<T, P, N> {
        IEthBridgeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IEthBridgeInstance<T, P, N>>,
    > {
        IEthBridgeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IEthBridgeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IEthBridge`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IEthBridge`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IEthBridgeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IEthBridgeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IEthBridgeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IEthBridgeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IEthBridgeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEthBridgeInstance<T, P, N> {
            IEthBridgeInstance {

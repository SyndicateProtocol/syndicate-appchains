...
```*/
    ...
    ///Container for all the [`IERC20Inbox`](self) function calls.
    pub enum IERC20InboxCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC20InboxCalls {
        const NAME: &'static str = "IERC20InboxCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC20InboxCalls>] = &[
                {
                    fn sendL2MessageFromOrigin(
                        ...
                        <sendL2MessageFromOriginCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::sendL2MessageFromOrigin)
                    }
                ...
                },
                {
                    fn allowListEnabled(
                        ...
                        <allowListEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::allowListEnabled)
                    }
                    allowListEnabled
                },
                {
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::initialize)
                    }
                    initialize
                },
                {
                    fn sendUnsignedTransaction(
                        ...
                        <sendUnsignedTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::sendUnsignedTransaction)
                    }
                ...
                },
                {
                    fn createRetryableTicket(
                        ...
                        <createRetryableTicketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::createRetryableTicket)
                    }
                ...
                },
                {
                    fn sendContractTransaction(
                        ...
                        <sendContractTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::sendContractTransaction)
                    }
                ...
                },
                {
                    fn getProxyAdmin(
                        ...
                        <getProxyAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::getProxyAdmin)
                    }
                    getProxyAdmin
                },
                {
                    fn calculateRetryableSubmissionFee(
                        ...
                        <calculateRetryableSubmissionFeeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::calculateRetryableSubmissionFee)
                    }
                ...
                },
                {
                    fn sendL2Message(
                        ...
                        <sendL2MessageCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::sendL2Message)
                    }
                    sendL2Message
                },
                {
                    fn depositERC20(
                        ...
                        <depositERC20Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::depositERC20)
                    }
                    depositERC20
                },
                {
                    fn unsafeCreateRetryableTicket(
                        ...
                        <unsafeCreateRetryableTicketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::unsafeCreateRetryableTicket)
                    }
                ...
                },
                {
                    fn isAllowed(
                        ...
                        <isAllowedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::isAllowed)
                    }
                    isAllowed
                },
                {
                    fn setAllowList(
                        ...
                        <setAllowListCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::setAllowList)
                    }
                    setAllowList
                },
                {
                ...
                },
                {
                    fn maxDataSize(
                        ...
                        <maxDataSizeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::maxDataSize)
                    }
                    maxDataSize
                },
                {
                    fn sequencerInbox(
                        ...
                        <sequencerInboxCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::sequencerInbox)
                    }
                    sequencerInbox
                },
                {
                    fn setAllowListEnabled(
                        ...
                        <setAllowListEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20InboxCalls::setAllowListEnabled)
                    }
                    setAllowListEnabled
                },
            ];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC20InboxEvents {
        const NAME: &'static str = "IERC20InboxEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC20InboxEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IERC20Inbox`](self) contract instance.

See the [wrapper's documentation](`IERC20InboxInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC20InboxInstance<T, P, N> {
        IERC20InboxInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC20InboxInstance<T, P, N>>,
    > {
        IERC20InboxInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC20InboxInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC20Inbox`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC20Inbox`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC20InboxInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC20InboxInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC20InboxInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC20InboxInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC20InboxInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC20InboxInstance<T, P, N> {
            IERC20InboxInstance {

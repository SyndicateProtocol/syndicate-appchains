...
```*/
    ...
    impl IERC20BridgeCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[225u8, 117u8, 139u8, 216u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC20BridgeCalls {
        const NAME: &'static str = "IERC20BridgeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC20BridgeCalls>] = &[
                {
                    fn nativeToken(
                        data: &[u8],
                        validate: bool,
                        ...
                        <nativeTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC20BridgeCalls::nativeToken)
                    }
                    nativeToken
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IERC20Bridge`](self) contract instance.

See the [wrapper's documentation](`IERC20BridgeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC20BridgeInstance<T, P, N> {
        IERC20BridgeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC20BridgeInstance<T, P, N>>,
    > {
        IERC20BridgeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC20BridgeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC20Bridge`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC20Bridge`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC20BridgeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC20BridgeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC20BridgeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC20BridgeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC20BridgeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC20BridgeInstance<T, P, N> {
            IERC20BridgeInstance {

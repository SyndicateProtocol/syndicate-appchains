...
See the [wrapper's documentation](`AccessControlEnumerableInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> AccessControlEnumerableInstance<T, P, N> {
        AccessControlEnumerableInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<AccessControlEnumerableInstance<T, P, N>>,
    > {
        AccessControlEnumerableInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        AccessControlEnumerableInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for AccessControlEnumerableInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<AccessControlEnumerableInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> AccessControlEnumerableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> AccessControlEnumerableInstance<T, P, N> {

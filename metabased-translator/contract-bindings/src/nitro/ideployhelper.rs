...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IDeployHelperCalls {
        const NAME: &'static str = "IDeployHelperCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IDeployHelperCalls>] = &[
                {
                    fn getDeploymentTotalCost(
                        ...
                        <getDeploymentTotalCostCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IDeployHelperCalls::getDeploymentTotalCost)
                    }
                ...
                },
                {
                    fn perform(
                        ...
                        <performCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IDeployHelperCalls::perform)
                    }
                    perform
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IDeployHelper`](self) contract instance.

See the [wrapper's documentation](`IDeployHelperInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IDeployHelperInstance<T, P, N> {
        IDeployHelperInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IDeployHelperInstance<T, P, N>>,
    > {
        IDeployHelperInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IDeployHelperInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IDeployHelper`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IDeployHelper`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IDeployHelperInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IDeployHelperInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IDeployHelperInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IDeployHelperInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IDeployHelperInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IDeployHelperInstance<T, P, N> {
            IDeployHelperInstance {

...
```solidity
interface DoubleLogicERC1967Upgrade {
...
```*/
    ...
    #[automatically_derived]
    impl DoubleLogicERC1967UpgradeEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for DoubleLogicERC1967UpgradeEvents {
        const NAME: &'static str = "DoubleLogicERC1967UpgradeEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for DoubleLogicERC1967UpgradeEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`DoubleLogicERC1967Upgrade`](self) contract instance.

See the [wrapper's documentation](`DoubleLogicERC1967UpgradeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> DoubleLogicERC1967UpgradeInstance<T, P, N> {
        DoubleLogicERC1967UpgradeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<DoubleLogicERC1967UpgradeInstance<T, P, N>>,
    > {
        DoubleLogicERC1967UpgradeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        DoubleLogicERC1967UpgradeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`DoubleLogicERC1967Upgrade`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`DoubleLogicERC1967Upgrade`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct DoubleLogicERC1967UpgradeInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for DoubleLogicERC1967UpgradeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("DoubleLogicERC1967UpgradeInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<DoubleLogicERC1967UpgradeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> DoubleLogicERC1967UpgradeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> DoubleLogicERC1967UpgradeInstance<T, P, N> {
            DoubleLogicERC1967UpgradeInstance {

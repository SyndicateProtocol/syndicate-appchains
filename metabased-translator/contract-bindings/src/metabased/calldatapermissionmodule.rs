...
```*/
    ...
    #[automatically_derived]
    impl CalldataPermissionModuleCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for CalldataPermissionModuleCalls {
        const NAME: &'static str = "CalldataPermissionModuleCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<CalldataPermissionModuleCalls>] = &[
                {
                    fn isCalldataAllowed(
                        ...
                        <isCalldataAllowedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(CalldataPermissionModuleCalls::isCalldataAllowed)
                    }
                    isCalldataAllowed
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`CalldataPermissionModule`](self) contract instance.

See the [wrapper's documentation](`CalldataPermissionModuleInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> CalldataPermissionModuleInstance<T, P, N> {
        CalldataPermissionModuleInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<CalldataPermissionModuleInstance<T, P, N>>,
    > {
        CalldataPermissionModuleInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        CalldataPermissionModuleInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`CalldataPermissionModule`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`CalldataPermissionModule`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct CalldataPermissionModuleInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for CalldataPermissionModuleInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("CalldataPermissionModuleInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<CalldataPermissionModuleInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> CalldataPermissionModuleInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> CalldataPermissionModuleInstance<T, P, N> {
            CalldataPermissionModuleInstance {

...
See the [wrapper's documentation](`IERC20ErrorsInstance`) for more details.*/
    ...
    >(
        ...
        IERC20ErrorsInstance::<T, P, N>::new(address, provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC20ErrorsInstance<T, P, N> {
        #[inline]
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC20ErrorsInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC20ErrorsInstance<T, P, N> {

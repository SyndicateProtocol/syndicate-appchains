    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for arbBlockHashCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = arbBlockHashReturn;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for arbOSVersionCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = arbOSVersionReturn;
            type ReturnTuple<'a> = (alloy::sol_types::sol_data::Uint<256>,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getStorageGasAvailableCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = getStorageGasAvailableReturn;
            type ReturnTuple<'a> = (alloy::sol_types::sol_data::Uint<256>,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for isTopLevelCallCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = isTopLevelCallReturn;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for mapL1SenderContractAddressToL2AliasCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = mapL1SenderContractAddressToL2AliasReturn;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for myCallersAddressWithoutAliasingCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = myCallersAddressWithoutAliasingReturn;
            type ReturnTuple<'a> = (alloy::sol_types::sol_data::Address,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for wasMyCallersAddressAliasedCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = wasMyCallersAddressAliasedReturn;
            type ReturnTuple<'a> = (alloy::sol_types::sol_data::Bool,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
        ...
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                ...
                Some(<L2ToL1Tx as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <L2ToL1Tx as alloy_sol_types::SolEvent>::decode_raw_log(
                            topics,
                            data,
                            validate,
                        )
...
See the [wrapper's documentation](`ArbSysInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> ArbSysInstance<T, P, N> {
        ArbSysInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ArbSysInstance<T, P, N>>,
    > {
        ArbSysInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ArbSysInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ArbSysInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ArbSysInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ArbSysInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ArbSysInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ArbSysInstance<T, P, N> {
            ArbSysInstance {
    ...
    > ArbSysInstance<T, P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<T, &P, arbBlockHashCall, N> {
        ...
        pub fn arbChainID(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, arbChainIDCall, N> {
            self.call_builder(&arbChainIDCall {})
        }
        ///Creates a new call builder for the [`arbOSVersion`] function.
        pub fn arbOSVersion(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, arbOSVersionCall, N> {
        ...
        pub fn getStorageGasAvailable(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, getStorageGasAvailableCall, N> {
        ...
        pub fn isTopLevelCall(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, isTopLevelCallCall, N> {
        ...
        pub fn sendMerkleTreeState(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, sendMerkleTreeStateCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<T, &P, sendTxToL1Call, N> {
            self.call_builder(
                &sendTxToL1Call {
                    destination,
                    data,
        ...
        pub fn wasMyCallersAddressAliased(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, wasMyCallersAddressAliasedCall, N> {

...
- [SyndicateFactory](contract.SyndicateFactory.md)
- [SyndicateSequencerChain](contract.SyndicateSequencerChain.md)
...
4. When users submit transactions to the rollup, it will be picked up by the sequencer chain via the execution pipeline:
   ...
   - validators called sequencers will submit transactions to the Syndicate sequencer chain

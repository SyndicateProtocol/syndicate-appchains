...
```*/
    ...
    const _: () = {
        ...
        impl constructOutboxProofReturn {
            fn _tokenize(
                &self,
            ) -> <constructOutboxProofCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                (
                    <alloy::sol_types::sol_data::FixedBytes<
                        32,
                    > as alloy_sol_types::SolType>::tokenize(&self.send),
                    <alloy::sol_types::sol_data::FixedBytes<
                        32,
        ...
        impl alloy_sol_types::SolCall for constructOutboxProofCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                constructOutboxProofReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl estimateRetryableTicketReturn {
            fn _tokenize(
                &self,
            ) -> <estimateRetryableTicketCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for estimateRetryableTicketCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                estimateRetryableTicketReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for findBatchContainingBlockCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: findBatchContainingBlockReturn = r.into();
                        r.batch
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl gasEstimateComponentsReturn {
            fn _tokenize(
                &self,
            ) -> <gasEstimateComponentsCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                (
                    <alloy::sol_types::sol_data::Uint<
                    ...
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.gasEstimateForL1),
                    <alloy::sol_types::sol_data::Uint<
                        256,
                    > as alloy_sol_types::SolType>::tokenize(&self.baseFee),
                    <alloy::sol_types::sol_data::Uint<
                        256,
                    > as alloy_sol_types::SolType>::tokenize(&self.l1BaseFeeEstimate),
                )
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for gasEstimateComponentsCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                gasEstimateComponentsReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl gasEstimateL1ComponentReturn {
            fn _tokenize(
                &self,
            ) -> <gasEstimateL1ComponentCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                (
                    <alloy::sol_types::sol_data::Uint<
        ...
        impl alloy_sol_types::SolCall for gasEstimateL1ComponentCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                gasEstimateL1ComponentReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getL1ConfirmationsCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: getL1ConfirmationsReturn = r.into();
                        r.confirmations
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl l2BlockRangeForL1Return {
            fn _tokenize(
                &self,
            ) -> <l2BlockRangeForL1Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                (
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.firstBlock),
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.lastBlock),
                )
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for l2BlockRangeForL1Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                l2BlockRangeForL1Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl legacyLookupMessageBatchProofReturn {
            fn _tokenize(
                &self,
            ) -> <legacyLookupMessageBatchProofCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                (
                    <alloy::sol_types::sol_data::Array<
        ...
        impl alloy_sol_types::SolCall for legacyLookupMessageBatchProofCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                legacyLookupMessageBatchProofReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for nitroGenesisBlockCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: nitroGenesisBlockReturn = r.into();
                        r.number
                    })
            }
            #[inline]
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<NodeInterfaceCalls>] = &[
                {
                    fn constructOutboxProof(
                        ...
                        <constructOutboxProofCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::constructOutboxProof)
                    }
                ...
                },
                {
                    fn l2BlockRangeForL1(
                        ...
                        <l2BlockRangeForL1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::l2BlockRangeForL1)
                    }
                ...
                },
                {
                    fn blockL1Num(
                        ...
                        <blockL1NumCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::blockL1Num)
                    }
                ...
                },
                {
                    fn gasEstimateL1Component(
                        ...
                        <gasEstimateL1ComponentCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::gasEstimateL1Component)
                    }
                ...
                },
                {
                    fn findBatchContainingBlock(
                        ...
                        <findBatchContainingBlockCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::findBatchContainingBlock)
                    }
                ...
                },
                {
                    fn legacyLookupMessageBatchProof(
                        ...
                        <legacyLookupMessageBatchProofCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::legacyLookupMessageBatchProof)
                    }
                ...
                },
                {
                    fn nitroGenesisBlock(
                        ...
                        <nitroGenesisBlockCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::nitroGenesisBlock)
                    }
                ...
                },
                {
                    fn estimateRetryableTicket(
                        ...
                        <estimateRetryableTicketCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::estimateRetryableTicket)
                    }
                ...
                },
                {
                    fn gasEstimateComponents(
                        ...
                        <gasEstimateComponentsCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::gasEstimateComponents)
                    }
                ...
                },
                {
                    fn getL1Confirmations(
                        ...
                        <getL1ConfirmationsCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(NodeInterfaceCalls::getL1Confirmations)
                    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct NodeInterfaceInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for NodeInterfaceInstance<P, N> {
        #[inline]
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> NodeInterfaceInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> NodeInterfaceInstance<P, N> {
    ...
    > NodeInterfaceInstance<P, N> {
        ...
        pub fn blockL1Num(
            &self,
            l2BlockNum: u64,
        ) -> alloy_contract::SolCallBuilder<&P, blockL1NumCall, N> {
        ...
        pub fn constructOutboxProof(
            ...
            size: u64,
            leaf: u64,
        ) -> alloy_contract::SolCallBuilder<&P, constructOutboxProofCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, estimateRetryableTicketCall, N> {
            self.call_builder(
        ...
        pub fn findBatchContainingBlock(
            &self,
            blockNum: u64,
        ) -> alloy_contract::SolCallBuilder<&P, findBatchContainingBlockCall, N> {
            self.call_builder(
        ...
        pub fn gasEstimateComponents(
            ...
            data: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, gasEstimateComponentsCall, N> {
            self.call_builder(
        ...
        pub fn gasEstimateL1Component(
            ...
            contractCreation: bool,
            data: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, gasEstimateL1ComponentCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, getL1ConfirmationsCall, N> {
            self.call_builder(
        ...
        pub fn l2BlockRangeForL1(
            &self,
            blockNum: u64,
        ) -> alloy_contract::SolCallBuilder<&P, l2BlockRangeForL1Call, N> {
        ...
        pub fn legacyLookupMessageBatchProof(
            ...
            index: u64,
        ) -> alloy_contract::SolCallBuilder<&P, legacyLookupMessageBatchProofCall, N> {
            self.call_builder(
        ...
        pub fn nitroGenesisBlock(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, nitroGenesisBlockCall, N> {

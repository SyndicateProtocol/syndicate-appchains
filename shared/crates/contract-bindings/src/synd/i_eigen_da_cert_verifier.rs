...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for Attestation {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "Attestation(BN254.G1Point[] nonSignerPubkeys,BN254.G1Point[] quorumApks,G1Point sigma,G2Point apkG2,uint32[] quorumNumbers)",
                )
            }
            #[inline]
            fn eip712_components() -> alloy_sol_types::private::Vec<
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for BlobCommitment {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "BlobCommitment(G1Point commitment,G2Point lengthCommitment,G2Point lengthProof,uint32 length)",
                )
            }
            #[inline]
            fn eip712_components() -> alloy_sol_types::private::Vec<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getNonSignerStakesAndSignatureCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = <NonSignerStakesAndSignature as alloy::sol_types::SolType>::RustType;
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: getNonSignerStakesAndSignatureReturn = r.into();
                        r._0
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertSecurityParams_0Return {
            fn _tokenize(
                &self,
            ) -> <verifyDACertSecurityParams_0Call as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for verifyDACertSecurityParams_0Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertSecurityParams_0Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertSecurityParams_1Return {
            fn _tokenize(
                &self,
            ) -> <verifyDACertSecurityParams_1Call as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for verifyDACertSecurityParams_1Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertSecurityParams_1Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertV1Return {
            fn _tokenize(
                &self,
            ) -> <verifyDACertV1Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for verifyDACertV1Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertV1Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertV2Return {
            fn _tokenize(
                &self,
            ) -> <verifyDACertV2Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for verifyDACertV2Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertV2Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for verifyDACertV2ForZKProofCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: verifyDACertV2ForZKProofReturn = r.into();
                        r._0
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertV2FromSignedBatchReturn {
            fn _tokenize(
                &self,
            ) -> <verifyDACertV2FromSignedBatchCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for verifyDACertV2FromSignedBatchCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertV2FromSignedBatchReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl verifyDACertsV1Return {
            fn _tokenize(
                &self,
            ) -> <verifyDACertsV1Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for verifyDACertsV1Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                verifyDACertsV1Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                },
                {
                    fn verifyDACertSecurityParams_0(
                        ...
                        <verifyDACertSecurityParams_0Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertSecurityParams_0)
                    }
                ...
                },
                {
                    fn verifyDACertsV1(
                        ...
                        <verifyDACertsV1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertsV1)
                    }
                ...
                },
                {
                    fn verifyDACertV2ForZKProof(
                        ...
                        <verifyDACertV2ForZKProofCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertV2ForZKProof)
                    }
                ...
                },
                {
                    fn verifyDACertV2FromSignedBatch(
                        ...
                        <verifyDACertV2FromSignedBatchCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(
                                IEigenDACertVerifierCalls::verifyDACertV2FromSignedBatch,
                ...
                },
                {
                    fn verifyDACertV1(
                        ...
                        <verifyDACertV1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertV1)
                    }
                ...
                },
                {
                    fn verifyDACertV2(
                        ...
                        <verifyDACertV2Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertV2)
                    }
                ...
                },
                {
                    fn verifyDACertSecurityParams_1(
                        ...
                        <verifyDACertSecurityParams_1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IEigenDACertVerifierCalls::verifyDACertSecurityParams_1)
                    }
                ...
                },
                {
                    fn getNonSignerStakesAndSignature(
                        ...
                        <getNonSignerStakesAndSignatureCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(
                                IEigenDACertVerifierCalls::getNonSignerStakesAndSignature,
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IEigenDACertVerifierInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IEigenDACertVerifierInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IEigenDACertVerifierInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEigenDACertVerifierInstance<P, N> {
    ...
    > IEigenDACertVerifierInstance<P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, getNonSignerStakesAndSignatureCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertSecurityParams_0Call, N> {
            self.call_builder(
        ...
        pub fn verifyDACertSecurityParams_1(
            ...
            version: u16,
            securityThresholds: <SecurityThresholds as alloy::sol_types::SolType>::RustType,
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertSecurityParams_1Call, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertV1Call, N> {
            self.call_builder(
                &verifyDACertV1Call {
                    blobHeader,
                    blobVerificationProof,
        ...
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertV2Call, N> {
            self.call_builder(
                &verifyDACertV2Call {
                    batchHeader,
                    blobInclusionInfo,
        ...
        pub fn verifyDACertV2ForZKProof(
            ...
            nonSignerStakesAndSignature: <NonSignerStakesAndSignature as alloy::sol_types::SolType>::RustType,
            signedQuorumNumbers: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertV2ForZKProofCall, N> {
            self.call_builder(
        ...
        pub fn verifyDACertV2FromSignedBatch(
            ...
            signedBatch: <SignedBatch as alloy::sol_types::SolType>::RustType,
            blobInclusionInfo: <BlobInclusionInfo as alloy::sol_types::SolType>::RustType,
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertV2FromSignedBatchCall, N> {
            self.call_builder(
        ...
        pub fn verifyDACertsV1(
            ...
            blobVerificationProofs: alloy::sol_types::private::Vec<
                <BlobVerificationProof as alloy::sol_types::SolType>::RustType,
            >,
        ) -> alloy_contract::SolCallBuilder<&P, verifyDACertsV1Call, N> {
            self.call_builder(
                &verifyDACertsV1Call {
                    blobHeaders,

                ...
                },
                {
                    fn MAX_PERMISSION_CHECKS(
                        ...
                        <MAX_PERMISSION_CHECKSCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseRequirementModuleCalls::MAX_PERMISSION_CHECKS)
                    }
                ...
                },
                {
                    fn TooManyPermissionChecks(
                        ...
                        <TooManyPermissionChecks as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BaseRequirementModuleErrors::TooManyPermissionChecks)
                    }
...
See the [wrapper's documentation](`BaseRequirementModuleInstance`) for more details.*/
    ...
    >(
        ...
        BaseRequirementModuleInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        BaseRequirementModuleInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        BaseRequirementModuleInstance::<P, N>::deploy_builder(__provider)
    }

...
```*/
    ...
    impl AddressStructuredLinkedListTestCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(test_InsertBefore),
            ::core::stringify!(excludeSenders),
            ::core::stringify!(targetInterfaces),
            ::core::stringify!(targetSenders),
            ::core::stringify!(targetContracts),
            ::core::stringify!(test_NodeExists),
            ::core::stringify!(targetArtifactSelectors),
            ::core::stringify!(test_ListTraversal),
            ::core::stringify!(test_PushFront),
            ::core::stringify!(targetArtifacts),
            ::core::stringify!(test_GetNode),
            ::core::stringify!(targetSelectors),
            ::core::stringify!(test_PushBack),
            ::core::stringify!(test_GetAdjacent),
            ::core::stringify!(test_InitialState),
            ::core::stringify!(excludeSelectors),
            ::core::stringify!(excludeArtifacts),
            ::core::stringify!(test_PopFront),
            ::core::stringify!(test_InsertAfter),
            ::core::stringify!(failed),
            ::core::stringify!(test_ComplexOperations),
            ::core::stringify!(excludeContracts),
            ::core::stringify!(test_EdgeCases),
            ::core::stringify!(IS_TEST),
            ::core::stringify!(test_PopBack),
            ::core::stringify!(test_Remove),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <test_InsertBeforeCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <test_NodeExistsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_ListTraversalCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_PushFrontCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_GetNodeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_PushBackCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_GetAdjacentCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <test_PopFrontCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_InsertAfterCall as alloy_sol_types::SolCall>::SIGNATURE,
            <failedCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_ComplexOperationsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <excludeContractsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_EdgeCasesCall as alloy_sol_types::SolCall>::SIGNATURE,
            <IS_TESTCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_PopBackCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_RemoveCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`AddressStructuredLinkedListTestInstance`) for more details.*/
    ...
    >(
        ...
        AddressStructuredLinkedListTestInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AddressStructuredLinkedListTestInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AddressStructuredLinkedListTestInstance::<P, N>::deploy_builder(__provider)
    }

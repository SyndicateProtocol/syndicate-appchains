...
```*/
    ...
    impl ReentrancyExecutorCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(setTarget),
            ::core::stringify!(executeCall),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <setTargetCall as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`ReentrancyExecutorInstance`) for more details.*/
    ...
    >(
        ...
        ReentrancyExecutorInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ReentrancyExecutorInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ReentrancyExecutorInstance::<P, N>::deploy_builder(__provider)
    }

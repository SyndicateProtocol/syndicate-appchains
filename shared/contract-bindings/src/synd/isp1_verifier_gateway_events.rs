...
See the [wrapper's documentation](`ISP1VerifierGatewayEventsInstance`) for more details.*/
    ...
    >(
        ...
        ISP1VerifierGatewayEventsInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ISP1VerifierGatewayEventsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISP1VerifierGatewayEventsInstance::<P, N>::deploy_builder(__provider)
    }

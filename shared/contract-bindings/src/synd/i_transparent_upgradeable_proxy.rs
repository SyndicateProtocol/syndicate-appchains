...
```*/
    ...
    impl ITransparentUpgradeableProxyCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[79u8, 30u8, 242u8, 134u8]];
    }
    #[automatically_derived]
...
See the [wrapper's documentation](`ITransparentUpgradeableProxyInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> ITransparentUpgradeableProxyInstance<P, N> {
        ITransparentUpgradeableProxyInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ITransparentUpgradeableProxyInstance<P, N>>,
    > {
        ITransparentUpgradeableProxyInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ITransparentUpgradeableProxyInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ITransparentUpgradeableProxyInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ITransparentUpgradeableProxyInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ITransparentUpgradeableProxyInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ITransparentUpgradeableProxyInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ITransparentUpgradeableProxyInstance<P, N> {

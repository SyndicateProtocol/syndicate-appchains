...
```*/
    ...
    ///Container for all the [`ISP1Verifier`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ISP1VerifierCalls {
        #[allow(missing_docs)]
        verifyProof(verifyProofCall),
    }
    impl ISP1VerifierCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ISP1VerifierCalls {
        const NAME: &'static str = "ISP1VerifierCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ISP1VerifierCalls>] = &[
                {
                    fn verifyProof(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<ISP1VerifierCalls> {
                        <verifyProofCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISP1VerifierCalls::verifyProof)
                    }
                    verifyProof
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ISP1Verifier`](self) contract instance.

See the [wrapper's documentation](`ISP1VerifierInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ISP1VerifierInstance<P, N> {
        ISP1VerifierInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISP1VerifierInstance<P, N>>,
    > {
        ISP1VerifierInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISP1VerifierInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ISP1Verifier`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ISP1Verifier`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ISP1VerifierInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISP1VerifierInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ISP1VerifierInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ISP1VerifierInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ISP1VerifierInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISP1VerifierInstance<P, N> {
            ISP1VerifierInstance {

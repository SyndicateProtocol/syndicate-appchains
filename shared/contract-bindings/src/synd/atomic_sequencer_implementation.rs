...
```*/
    ...
    impl AtomicSequencerImplementationCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(processTransactionsAtomically),
            ::core::stringify!(processTransactionsBulkAtomically),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <processTransactionsAtomicallyCall as alloy_sol_types::SolCall>::SIGNATURE,
            <processTransactionsBulkAtomicallyCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
    ...
    impl AtomicSequencerImplementationErrors {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(InputLengthMismatchError),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <InputLengthMismatchError as alloy_sol_types::SolError>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(

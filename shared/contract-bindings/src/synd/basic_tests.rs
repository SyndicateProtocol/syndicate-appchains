...
```*/
    ...
    impl BasicTestsCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(testImmutableValues),
            ::core::stringify!(ARBITRUM_BRIDGE_ADDRESS),
            ::core::stringify!(testInitialMutableValues),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <testImmutableValuesCall as alloy_sol_types::SolCall>::SIGNATURE,
            <ARBITRUM_BRIDGE_ADDRESSCall as alloy_sol_types::SolCall>::SIGNATURE,
            <testInitialMutableValuesCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <testOwnershipCall as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`BasicTestsInstance`) for more details.*/
    ...
    >(
        ...
        BasicTestsInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        BasicTestsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        BasicTestsInstance::<P, N>::deploy_builder(__provider)
    }

...
```*/
    ...
    impl IArbInboxCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[84u8, 158u8, 132u8, 38u8]];
            ...
            ) -> alloy_sol_types::Result<IArbInboxCalls>] = &[
                {
                    fn createRetryableTicket(
                        ...
                        <createRetryableTicketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IArbInboxCalls::createRetryableTicket)
                    }
...
See the [wrapper's documentation](`IArbInboxInstance`) for more details.*/
    ...
    >(
        ...
        IArbInboxInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IArbInboxInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IArbInboxInstance::<P, N>::deploy_builder(__provider)
    }

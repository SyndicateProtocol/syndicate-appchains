...
```*/
    ...
    impl ISP1VerifierWithHashCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(VERIFIER_HASH),
            ::core::stringify!(verifyProof),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <VERIFIER_HASHCall as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`ISP1VerifierWithHashInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> ISP1VerifierWithHashInstance<P, N> {
        ISP1VerifierWithHashInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISP1VerifierWithHashInstance<P, N>>,
    > {
        ISP1VerifierWithHashInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISP1VerifierWithHashInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ISP1VerifierWithHashInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISP1VerifierWithHashInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ISP1VerifierWithHashInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ISP1VerifierWithHashInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISP1VerifierWithHashInstance<P, N> {

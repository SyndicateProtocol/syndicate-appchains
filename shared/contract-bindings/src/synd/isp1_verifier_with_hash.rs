...
See the [wrapper's documentation](`ISP1VerifierWithHashInstance`) for more details.*/
    ...
    >(
        ...
        ISP1VerifierWithHashInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ISP1VerifierWithHashInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISP1VerifierWithHashInstance::<P, N>::deploy_builder(provider)
    }

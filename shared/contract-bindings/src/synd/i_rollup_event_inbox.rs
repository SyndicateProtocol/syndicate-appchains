...
```*/
    ...
    impl IRollupEventInboxCalls {
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <rollupInitializedCall as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`IRollupEventInboxInstance`) for more details.*/
    ...
    >(
        ...
        IRollupEventInboxInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IRollupEventInboxInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IRollupEventInboxInstance::<P, N>::deploy_builder(__provider)
    }

...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for mockPublicKeyToReturnCall {
            ...
            type Return = mockPublicKeyToReturnReturn;
...
See the [wrapper's documentation](`MockAttestationDocVerifierInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> MockAttestationDocVerifierInstance<T, P, N> {
        MockAttestationDocVerifierInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<MockAttestationDocVerifierInstance<T, P, N>>,
    > {
        MockAttestationDocVerifierInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        MockAttestationDocVerifierInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for MockAttestationDocVerifierInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<MockAttestationDocVerifierInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> MockAttestationDocVerifierInstance<T, &P, N> {
    ...
    > MockAttestationDocVerifierInstance<T, P, N> {
        ...
        pub fn mockPublicKeyToReturn(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, mockPublicKeyToReturnCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<T, &P, setPublicKeyToReturnCall, N> {

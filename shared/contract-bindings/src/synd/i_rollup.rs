...
```*/
    ...
    impl IRollupCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(forceConfirmNode),
            ...
            ::core::stringify!(forceCreateNode),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <forceConfirmNodeCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <forceCreateNodeCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl alloy_sol_types::SolInterface for IRollupCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IRollupCalls>] = &[
                {
                    fn challengeManager(
                        data: &[u8],
                ...
                {
                    fn stakeToken(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn isStaked(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn baseStake(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn isZombie(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn getNode(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn chainId(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn getStaker(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn outbox(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
                ...
                {
                    fn bridge(data: &[u8]) -> alloy_sol_types::Result<IRollupCalls> {
...
See the [wrapper's documentation](`IRollupInstance`) for more details.*/
    ...
    >(
        ...
        IRollupInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IRollupInstance<P, N>>,
    > {
        IRollupInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IRollupInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IRollupInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IRollupInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IRollupInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IRollupInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IRollupInstance<P, N> {
            IRollupInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,

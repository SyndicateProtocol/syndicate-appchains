            ...
            static DECODE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<ReentrancyAttackerCalls>] = &[
                {
                    fn attack(
                        ...
                        <attackCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                                validate,
                            )
...
See the [wrapper's documentation](`ReentrancyAttackerInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> ReentrancyAttackerInstance<T, P, N> {
        ReentrancyAttackerInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ReentrancyAttackerInstance<T, P, N>>,
    > {
        ReentrancyAttackerInstance::<T, P, N>::deploy(provider, _target)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        ReentrancyAttackerInstance::<T, P, N>::deploy_builder(provider, _target)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ReentrancyAttackerInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ReentrancyAttackerInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
            _target: alloy::sol_types::private::Address,
        ) -> alloy_contract::Result<ReentrancyAttackerInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ReentrancyAttackerInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ReentrancyAttackerInstance<T, P, N> {
    ...
    > ReentrancyAttackerInstance<T, P, N> {
        ...
        pub fn attack(&self) -> alloy_contract::SolCallBuilder<T, &P, attackCall, N> {

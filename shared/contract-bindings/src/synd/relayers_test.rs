...
```*/
    ...
    impl RelayersTestCalls {
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <test_refunderCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <dummyTokenCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l1RelayerCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_admin_refunderCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2RelayerCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <test_admin_L2RelayerCall as alloy_sol_types::SolCall>::SIGNATURE,
            <refunderCall as alloy_sol_types::SolCall>::SIGNATURE,
            <excludeContractsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <adminCall as alloy_sol_types::SolCall>::SIGNATURE,
            <opMessageRelayerCall as alloy_sol_types::SolCall>::SIGNATURE,
            <IS_TESTCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_admin_L1RelayerCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`RelayersTestInstance`) for more details.*/
    ...
    >(
        ...
        RelayersTestInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        RelayersTestInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        RelayersTestInstance::<P, N>::deploy_builder(__provider)
    }

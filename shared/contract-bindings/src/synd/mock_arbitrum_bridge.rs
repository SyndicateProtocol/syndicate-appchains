...
```*/
    ...
    impl MockArbitrumBridgeCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(getTransferCallCount),
            ::core::stringify!(outboundTransferCustomRefund),
            ::core::stringify!(setShouldRevert),
            ::core::stringify!(transferCalls),
            ::core::stringify!(mockGateway),
            ::core::stringify!(getGateway),
            ::core::stringify!(shouldRevert),
            ::core::stringify!(getLastTransferCall),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <getTransferCallCountCall as alloy_sol_types::SolCall>::SIGNATURE,
            <outboundTransferCustomRefundCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setShouldRevertCall as alloy_sol_types::SolCall>::SIGNATURE,
            <transferCallsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <mockGatewayCall as alloy_sol_types::SolCall>::SIGNATURE,
            <getGatewayCall as alloy_sol_types::SolCall>::SIGNATURE,
            <shouldRevertCall as alloy_sol_types::SolCall>::SIGNATURE,
            <getLastTransferCallCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`MockArbitrumBridgeInstance`) for more details.*/
    ...
    >(
        ...
        MockArbitrumBridgeInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        MockArbitrumBridgeInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MockArbitrumBridgeInstance::<P, N>::deploy_builder(__provider)
    }

...
See the [wrapper's documentation](`BeaconProxyInstance`) for more details.*/
    ...
    >(
        ...
        BeaconProxyInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        BeaconProxyInstance::<P, N>::deploy(__provider, beacon, data)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        BeaconProxyInstance::<P, N>::deploy_builder(__provider, beacon, data)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            ...
            let call_builder = Self::deploy_builder(__provider, beacon, data);

    ...
    impl alloy_sol_types::SolInterface for IInboxBaseCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn unpause(data: &[u8]) -> alloy_sol_types::Result<IInboxBaseCalls> {
                ...
                {
                    fn pause(data: &[u8]) -> alloy_sol_types::Result<IInboxBaseCalls> {
                ...
                {
                    fn bridge(data: &[u8]) -> alloy_sol_types::Result<IInboxBaseCalls> {
...
See the [wrapper's documentation](`IInboxBaseInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> IInboxBaseInstance<P, N> {
        IInboxBaseInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IInboxBaseInstance<P, N>>,
    > {
        IInboxBaseInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IInboxBaseInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IInboxBaseInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IInboxBaseInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IInboxBaseInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IInboxBaseInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IInboxBaseInstance<P, N> {
            IInboxBaseInstance {

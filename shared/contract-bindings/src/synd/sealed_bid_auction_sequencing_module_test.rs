...
See the [wrapper's documentation](`SealedBidAuctionSequencingModuleTestInstance`) for more details.*/
    ...
    >(
        ...
        SealedBidAuctionSequencingModuleTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        >,
    > {
        SealedBidAuctionSequencingModuleTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        SealedBidAuctionSequencingModuleTestInstance::<P, N>::deploy_builder(provider)
    }

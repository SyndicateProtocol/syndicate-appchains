...
See the [wrapper's documentation](`MockRewardPoolBaseInstance`) for more details.*/
    ...
    >(
        ...
        MockRewardPoolBaseInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        MockRewardPoolBaseInstance::<
            P,
            N,
        >::deploy(__provider, _defaultAdmin, _staking, _gas)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        MockRewardPoolBaseInstance::<
            P,
            N,
        >::deploy_builder(__provider, _defaultAdmin, _staking, _gas)
    }

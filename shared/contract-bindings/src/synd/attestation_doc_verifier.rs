...
```*/
    ...
    impl AttestationDocVerifierCalls {
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            <rootCertHashCall as alloy_sol_types::SolCall>::SIGNATURE,
            <verifierCall as alloy_sol_types::SolCall>::SIGNATURE,
            <pcr2Call as alloy_sol_types::SolCall>::SIGNATURE,
            <syndCommitHashCall as alloy_sol_types::SolCall>::SIGNATURE,
            <pcr0Call as alloy_sol_types::SolCall>::SIGNATURE,
            <verifyAttestationDocProofCall as alloy_sol_types::SolCall>::SIGNATURE,
            <pcr1Call as alloy_sol_types::SolCall>::SIGNATURE,

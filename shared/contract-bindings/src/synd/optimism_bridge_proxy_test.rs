...
See the [wrapper's documentation](`OptimismBridgeProxyTestInstance`) for more details.*/
    ...
    >(
        ...
        OptimismBridgeProxyTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        OptimismBridgeProxyTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        OptimismBridgeProxyTestInstance::<P, N>::deploy_builder(provider)
    }

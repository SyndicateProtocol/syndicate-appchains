...
See the [wrapper's documentation](`TestnetSyndTokenCrosschainTestInstance`) for more details.*/
    ...
    >(
        ...
        TestnetSyndTokenCrosschainTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        TestnetSyndTokenCrosschainTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        TestnetSyndTokenCrosschainTestInstance::<P, N>::deploy_builder(provider)
    }

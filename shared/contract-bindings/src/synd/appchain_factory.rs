...
```*/
    ...
    pub struct getAppchainsAndContractsReturn {
        ...
        >,
        #[allow(missing_docs)]
        pub contracts: alloy::sol_types::private::Vec<
        ...
        }
        {
            ...
            for UnderlyingRustTuple<'_> {
                fn from(value: getAppchainsAndContractsReturn) -> Self {
                    (value.chainIDs, value.contracts)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
        ...
        impl getAppchainsAndContractsReturn {
            ...
            > {
                (
                    ...
                    > as alloy_sol_types::SolType>::tokenize(&self.contracts),
                )
            }
        }
        #[automatically_derived]
            ...
            ) -> alloy_sol_types::Result<AppchainFactoryCalls>] = &[
                {
                    fn getAppchainsAndContracts(
                        ...
                        <getAppchainsAndContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AppchainFactoryCalls::getAppchainsAndContracts)
                    }
                ...
                },
                {
                    fn getTotalAppchains(
                        ...
                        <getTotalAppchainsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AppchainFactoryCalls::getTotalAppchains)
                    }
                    getTotalAppchains
                },
                {
                    fn getContractsForAppchains(
                        ...
                        <getContractsForAppchainsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(AppchainFactoryCalls::getContractsForAppchains)
                    }
...
See the [wrapper's documentation](`AppchainFactoryInstance`) for more details.*/
    ...
    >(
        ...
        AppchainFactoryInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AppchainFactoryInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AppchainFactoryInstance::<P, N>::deploy_builder(__provider)
    }

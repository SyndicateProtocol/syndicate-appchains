...
```*/
    ...
    impl MockAttestationDocVerifierCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(setPublicKeyToReturn),
            ::core::stringify!(setShouldRevert),
            ::core::stringify!(verifyAttestationDocProof),
            ::core::stringify!(shouldRevert),
            ::core::stringify!(mockPublicKeyToReturn),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <setPublicKeyToReturnCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <mockPublicKeyToReturnCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`MockAttestationDocVerifierInstance`) for more details.*/
    ...
    >(
        ...
        MockAttestationDocVerifierInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        MockAttestationDocVerifierInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MockAttestationDocVerifierInstance::<P, N>::deploy_builder(__provider)
    }

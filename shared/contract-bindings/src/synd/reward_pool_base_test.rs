...
```*/
    ...
    impl RewardPoolBaseTestCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(test_computePartial),
            ::core::stringify!(test_computeDiminishingFactors),
            ...
            ::core::stringify!(gasProvider),
            ::core::stringify!(test_getAppchainTotalReward),
            ::core::stringify!(rewardPoolBase),
            ::core::stringify!(targetArtifacts),
            ::core::stringify!(appchainId2),
            ::core::stringify!(targetSelectors),
            ::core::stringify!(test_computeLargeBatch),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <test_computePartialCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_computeDiminishingFactorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <gasProviderCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_getAppchainTotalRewardCall as alloy_sol_types::SolCall>::SIGNATURE,
            <rewardPoolBaseCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <test_computeLargeBatchCall as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`RewardPoolBaseTestInstance`) for more details.*/
    ...
    >(
        ...
        RewardPoolBaseTestInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        RewardPoolBaseTestInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        RewardPoolBaseTestInstance::<P, N>::deploy_builder(__provider)
    }

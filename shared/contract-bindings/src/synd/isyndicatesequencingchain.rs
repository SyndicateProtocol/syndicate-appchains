                ...
                },
                {
                    fn processTransactionUncompressed(
                        ...
                        <processTransactionUncompressedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                ISyndicateSequencingChainCalls::processTransactionUncompressed,
                            )
                    }
...
See the [wrapper's documentation](`ISyndicateSequencingChainInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> ISyndicateSequencingChainInstance<T, P, N> {
        ISyndicateSequencingChainInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISyndicateSequencingChainInstance<T, P, N>>,
    > {
        ISyndicateSequencingChainInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ISyndicateSequencingChainInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ISyndicateSequencingChainInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ISyndicateSequencingChainInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ISyndicateSequencingChainInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISyndicateSequencingChainInstance<T, P, N> {

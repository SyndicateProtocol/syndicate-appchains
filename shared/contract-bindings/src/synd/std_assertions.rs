...
```*/
    ...
    impl StdAssertionsCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(failed)];
...
See the [wrapper's documentation](`StdAssertionsInstance`) for more details.*/
    ...
    >(
        ...
        StdAssertionsInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        StdAssertionsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        StdAssertionsInstance::<P, N>::deploy_builder(__provider)
    }

...
See the [wrapper's documentation](`InitializeEmissionsV2Instance`) for more details.*/
    ...
    >(
        ...
        InitializeEmissionsV2Instance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        InitializeEmissionsV2Instance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        InitializeEmissionsV2Instance::<P, N>::deploy_builder(provider)
    }

...
```*/
    ...
    impl IAssertionPosterCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[218u8, 234u8, 180u8, 18u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IAssertionPosterCalls {
        const NAME: &'static str = "IAssertionPosterCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IAssertionPosterCalls>] = &[
                {
                    fn postAssertion(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IAssertionPosterCalls> {
                        <postAssertionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAssertionPosterCalls::postAssertion)
                    }
                    postAssertion
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IAssertionPoster`](self) contract instance.

See the [wrapper's documentation](`IAssertionPosterInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IAssertionPosterInstance<P, N> {
        IAssertionPosterInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IAssertionPosterInstance<P, N>>,
    > {
        IAssertionPosterInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IAssertionPosterInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IAssertionPoster`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IAssertionPoster`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IAssertionPosterInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IAssertionPosterInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IAssertionPosterInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IAssertionPosterInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IAssertionPosterInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IAssertionPosterInstance<P, N> {
            IAssertionPosterInstance {

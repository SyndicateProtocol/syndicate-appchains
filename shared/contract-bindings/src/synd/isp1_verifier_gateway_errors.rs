...
```*/
    ...
    impl ISP1VerifierGatewayErrorsErrors {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(SelectorCannotBeZero),
            ::core::stringify!(RouteAlreadyExists),
            ::core::stringify!(RouteIsFrozen),
            ::core::stringify!(RouteNotFound),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <SelectorCannotBeZero as alloy_sol_types::SolError>::SIGNATURE,
            <RouteAlreadyExists as alloy_sol_types::SolError>::SIGNATURE,
            <RouteIsFrozen as alloy_sol_types::SolError>::SIGNATURE,
            <RouteNotFound as alloy_sol_types::SolError>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`ISP1VerifierGatewayErrorsInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> ISP1VerifierGatewayErrorsInstance<P, N> {
        ISP1VerifierGatewayErrorsInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISP1VerifierGatewayErrorsInstance<P, N>>,
    > {
        ISP1VerifierGatewayErrorsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISP1VerifierGatewayErrorsInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISP1VerifierGatewayErrorsInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ISP1VerifierGatewayErrorsInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ISP1VerifierGatewayErrorsInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISP1VerifierGatewayErrorsInstance<P, N> {

    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getCurrentPeriodCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = <GasPeriod as alloy::sol_types::SolType>::RustType;
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<GasPeriod as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    impl alloy_sol_types::SolInterface for GasCounterCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn periodDuration(
                        ...
                        <periodDurationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(GasCounterCalls::periodDuration)
                    }
                    periodDuration
                },
                {
                ...
                {
                    fn periods(data: &[u8]) -> alloy_sol_types::Result<GasCounterCalls> {

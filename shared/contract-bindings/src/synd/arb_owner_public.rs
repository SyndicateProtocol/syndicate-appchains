    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for ChainOwnerRectified {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                20u8, 199u8, 201u8, 203u8, 5u8, 248u8, 68u8, 72u8, 160u8, 242u8, 252u8,
                87u8, 117u8, 164u8, 4u8, 138u8, 114u8, 16u8, 203u8, 4u8, 10u8, 53u8,
                253u8, 132u8, 205u8, 69u8, 178u8, 184u8, 99u8, 208u8, 77u8, 130u8,
            ]);
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getBrotliCompressionLevelCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: getBrotliCompressionLevelReturn = r.into();
                        r._0
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl getScheduledUpgradeReturn {
            fn _tokenize(
                &self,
            ) -> <getScheduledUpgradeCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                (
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.arbosVersion),
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.scheduledForTimestamp),
                )
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for getScheduledUpgradeCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                getScheduledUpgradeReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl rectifyChainOwnerReturn {
            fn _tokenize(
                &self,
            ) -> <rectifyChainOwnerCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for rectifyChainOwnerCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                rectifyChainOwnerReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    impl ArbOwnerPublicCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(getBrotliCompressionLevel),
            ::core::stringify!(isChainOwner),
            ::core::stringify!(getNetworkFeeAccount),
            ::core::stringify!(getAllChainOwners),
            ::core::stringify!(rectifyChainOwner),
            ::core::stringify!(getScheduledUpgrade),
            ::core::stringify!(getInfraFeeAccount),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <getBrotliCompressionLevelCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <rectifyChainOwnerCall as alloy_sol_types::SolCall>::SIGNATURE,
            <getScheduledUpgradeCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<ArbOwnerPublicCalls>] = &[
                {
                    fn getBrotliCompressionLevel(
                        ...
                        <getBrotliCompressionLevelCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(ArbOwnerPublicCalls::getBrotliCompressionLevel)
                    }
                ...
                },
                {
                    fn rectifyChainOwner(
                        ...
                        <rectifyChainOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(ArbOwnerPublicCalls::rectifyChainOwner)
                    }
                ...
                },
                {
                    fn getScheduledUpgrade(
                        ...
                        <getScheduledUpgradeCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(ArbOwnerPublicCalls::getScheduledUpgrade)
                    }
    ...
    impl ArbOwnerPublicEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(ChainOwnerRectified),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <ChainOwnerRectified as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
...
See the [wrapper's documentation](`ArbOwnerPublicInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> ArbOwnerPublicInstance<P, N> {
        ArbOwnerPublicInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ArbOwnerPublicInstance<P, N>>,
    > {
        ArbOwnerPublicInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ArbOwnerPublicInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ArbOwnerPublicInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ArbOwnerPublicInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ArbOwnerPublicInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ArbOwnerPublicInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ArbOwnerPublicInstance<P, N> {
    ...
    > ArbOwnerPublicInstance<P, N> {
        ...
        pub fn getBrotliCompressionLevel(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, getBrotliCompressionLevelCall, N> {
        ...
        pub fn getScheduledUpgrade(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, getScheduledUpgradeCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, rectifyChainOwnerCall, N> {
            self.call_builder(
    ...
    > ArbOwnerPublicInstance<P, N> {
        ...
        pub fn ChainOwnerRectified_filter(
            &self,
        ) -> alloy_contract::Event<&P, ChainOwnerRectified, N> {

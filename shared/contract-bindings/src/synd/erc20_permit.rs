...
```*/
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20PermitCalls {
        const NAME: &'static str = "ERC20PermitCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ERC20PermitCalls>] = &[
                {
                    fn name(data: &[u8]) -> alloy_sol_types::Result<ERC20PermitCalls> {
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::name)
                    }
                    name
                },
                {
                ...
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20PermitCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20PermitCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                ...
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20PermitCalls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn nonces(data: &[u8]) -> alloy_sol_types::Result<ERC20PermitCalls> {
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::nonces)
                    }
                    nonces
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20PermitCalls::eip712Domain)
                    }
                    eip712Domain
                },
                {
                    fn symbol(data: &[u8]) -> alloy_sol_types::Result<ERC20PermitCalls> {
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::symbol)
                    }
                    symbol
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::transfer)
                    }
                    transfer
                },
                {
                    fn permit(data: &[u8]) -> alloy_sol_types::Result<ERC20PermitCalls> {
                        <permitCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::permit)
                    }
                    permit
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20PermitCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20PermitErrors {
        const NAME: &'static str = "ERC20PermitErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ERC20PermitErrors>] = &[
                {
                    fn StringTooLong(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<ERC20PermitErrors> {
                        <StringTooLong as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::StringTooLong)
                    }
                    StringTooLong
                },
                {
                    fn ERC2612InvalidSigner(
                        ...
                        <ERC2612InvalidSigner as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC2612InvalidSigner)
                    }
                ...
                },
                {
                    fn ERC2612ExpiredSignature(
                        ...
                        <ERC2612ExpiredSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC2612ExpiredSignature)
                    }
                ...
                },
                {
                    fn InvalidAccountNonce(
                        ...
                        <InvalidAccountNonce as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::InvalidAccountNonce)
                    }
                    InvalidAccountNonce
                },
                {
                    fn ERC20InvalidSpender(
                        ...
                        <ERC20InvalidSpender as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InvalidSpender)
                    }
                    ERC20InvalidSpender
                },
                {
                    fn ERC20InvalidSender(
                        ...
                        <ERC20InvalidSender as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InvalidSender)
                    }
                    ERC20InvalidSender
                },
                {
                    fn InvalidShortString(
                        ...
                        <InvalidShortString as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::InvalidShortString)
                    }
                    InvalidShortString
                },
                {
                    fn ECDSAInvalidSignatureS(
                        ...
                        <ECDSAInvalidSignatureS as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ECDSAInvalidSignatureS)
                    }
                ...
                },
                {
                    fn ERC20InsufficientBalance(
                        ...
                        <ERC20InsufficientBalance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InsufficientBalance)
                    }
                ...
                },
                {
                    fn ERC20InvalidApprover(
                        ...
                        <ERC20InvalidApprover as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InvalidApprover)
                    }
                ...
                },
                {
                    fn ERC20InvalidReceiver(
                        ...
                        <ERC20InvalidReceiver as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InvalidReceiver)
                    }
                ...
                },
                {
                    fn ECDSAInvalidSignature(
                        ...
                        <ECDSAInvalidSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ECDSAInvalidSignature)
                    }
                ...
                },
                {
                    fn ERC20InsufficientAllowance(
                        ...
                        <ERC20InsufficientAllowance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ERC20InsufficientAllowance)
                    }
                ...
                },
                {
                    fn ECDSAInvalidSignatureLength(
                        ...
                        <ECDSAInvalidSignatureLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20PermitErrors::ECDSAInvalidSignatureLength)
                    }
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC20PermitEvents {
        const NAME: &'static str = "ERC20PermitEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC20PermitEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`ERC20Permit`](self) contract instance.

See the [wrapper's documentation](`ERC20PermitInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ERC20PermitInstance<P, N> {
        ERC20PermitInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC20PermitInstance<P, N>>,
    > {
        ERC20PermitInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ERC20PermitInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ERC20Permit`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC20Permit`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC20PermitInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ERC20PermitInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20PermitInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ERC20PermitInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ERC20PermitInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC20PermitInstance<P, N> {
            ERC20PermitInstance {

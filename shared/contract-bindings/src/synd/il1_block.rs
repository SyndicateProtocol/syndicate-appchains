...
```*/
    ...
    impl IL1BlockCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[9u8, 189u8, 90u8, 96u8]];
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(hash)];
...
See the [wrapper's documentation](`IL1BlockInstance`) for more details.*/
    ...
    >(
        ...
        IL1BlockInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IL1BlockInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IL1BlockInstance::<P, N>::deploy_builder(__provider)
    }

...
See the [wrapper's documentation](`BaseAttestationDocVerifierTestInstance`) for more details.*/
    ...
    >(
        ...
        BaseAttestationDocVerifierTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        BaseAttestationDocVerifierTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        BaseAttestationDocVerifierTestInstance::<P, N>::deploy_builder(provider)
    }

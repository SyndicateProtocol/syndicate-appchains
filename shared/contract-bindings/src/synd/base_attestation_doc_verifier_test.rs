...
interface BaseAttestationDocVerifierTest {
...
pub mod BaseAttestationDocVerifierTest {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
...
```*/
    ...
    ///Container for all the [`BaseAttestationDocVerifierTest`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum BaseAttestationDocVerifierTestCalls {
        #[allow(missing_docs)]
        IS_TEST(IS_TESTCall),
        #[allow(missing_docs)]
    ...
    impl BaseAttestationDocVerifierTestCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for BaseAttestationDocVerifierTestCalls {
        const NAME: &'static str = "BaseAttestationDocVerifierTestCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<BaseAttestationDocVerifierTestCalls>] = &[
                {
                    fn setUp(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BaseAttestationDocVerifierTestCalls> {
                        <setUpCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseAttestationDocVerifierTestCalls::setUp)
                    }
                    setUp
                },
                {
                    fn gateway(
                        ...
                        <gatewayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseAttestationDocVerifierTestCalls::gateway)
                    }
                    gateway
                },
                {
                    fn excludeSenders(
                        ...
                        <excludeSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::excludeSenders)
                    }
                    excludeSenders
                },
                {
                    fn targetInterfaces(
                        ...
                        <targetInterfacesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::targetInterfaces)
                    }
                    targetInterfaces
                },
                {
                    fn testRevert_WrongRootCertHash(
                        ...
                        <testRevert_WrongRootCertHashCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_WrongRootCertHash,
                            )
                    }
                ...
                },
                {
                    fn loadFixture(
                        ...
                        <loadFixtureCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::loadFixture)
                    }
                    loadFixture
                },
                {
                    fn testRevert_InvalidAttestationDocVerifierProof(
                        ...
                        <testRevert_InvalidAttestationDocVerifierProofCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_InvalidAttestationDocVerifierProof,
                            )
                    }
                    testRevert_InvalidAttestationDocVerifierProof
                },
                {
                    fn targetSenders(
                        ...
                        <targetSendersCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::targetSenders)
                    }
                    targetSenders
                },
                {
                    fn targetContracts(
                        ...
                        <targetContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::targetContracts)
                    }
                    targetContracts
                },
                {
                    fn attestationDocVerifier(
                        ...
                        <attestationDocVerifierCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::attestationDocVerifier,
                            )
                    }
                ...
                },
                {
                    fn testConstructorWithLargeExpirationTolerance(
                        ...
                        <testConstructorWithLargeExpirationToleranceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testConstructorWithLargeExpirationTolerance,
                            )
                    }
                    testConstructorWithLargeExpirationTolerance
                },
                {
                    fn testRevert_WrongPCRValues(
                        ...
                        <testRevert_WrongPCRValuesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_WrongPCRValues,
                            )
                    }
                ...
                },
                {
                    fn getFixturePath(
                        ...
                        <getFixturePathCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::getFixturePath)
                    }
                    getFixturePath
                },
                {
                    fn testConstructorWithZeroExpirationTolerance(
                        ...
                        <testConstructorWithZeroExpirationToleranceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testConstructorWithZeroExpirationTolerance,
                            )
                    }
                    testConstructorWithZeroExpirationTolerance
                },
                {
                    fn targetArtifactSelectors(
                        ...
                        <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::targetArtifactSelectors,
                            )
                    }
                ...
                },
                {
                    fn targetArtifacts(
                        ...
                        <targetArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::targetArtifacts)
                    }
                    targetArtifacts
                },
                {
                    fn testRevert_ValidityWindowEnded(
                        ...
                        <testRevert_ValidityWindowEndedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_ValidityWindowEnded,
                            )
                    }
                ...
                },
                {
                    fn test_ValidAttestationDocVerifierProof(
                        ...
                        <test_ValidAttestationDocVerifierProofCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::test_ValidAttestationDocVerifierProof,
                            )
                    }
                ...
                },
                {
                    fn targetSelectors(
                        ...
                        <targetSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::targetSelectors)
                    }
                    targetSelectors
                },
                {
                    fn testRevert_TimestampManipulationEdgeCase(
                        ...
                        <testRevert_TimestampManipulationEdgeCaseCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_TimestampManipulationEdgeCase,
                            )
                    }
                    testRevert_TimestampManipulationEdgeCase
                },
                {
                    fn testRevert_MalformedPublicValues(
                        ...
                        <testRevert_MalformedPublicValuesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_MalformedPublicValues,
                            )
                    }
                ...
                },
                {
                    fn excludeSelectors(
                        ...
                        <excludeSelectorsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::excludeSelectors)
                    }
                    excludeSelectors
                },
                {
                    fn excludeArtifacts(
                        ...
                        <excludeArtifactsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::excludeArtifacts)
                    }
                    excludeArtifacts
                },
                {
                    fn failed(
                        ...
                        <failedCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseAttestationDocVerifierTestCalls::failed)
                    }
                    failed
                },
                {
                    fn excludeContracts(
                        ...
                        <excludeContractsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BaseAttestationDocVerifierTestCalls::excludeContracts)
                    }
                    excludeContracts
                },
                {
                    fn testRevert_ValidityWindowNotStarted(
                        ...
                        <testRevert_ValidityWindowNotStartedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                BaseAttestationDocVerifierTestCalls::testRevert_ValidityWindowNotStarted,
                            )
                    }
                ...
                },
                {
                    fn IS_TEST(
                        ...
                        <IS_TESTCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BaseAttestationDocVerifierTestCalls::IS_TEST)
                    }
                    IS_TEST
                },
            ];
    ...
    ///Container for all the [`BaseAttestationDocVerifierTest`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum BaseAttestationDocVerifierTestEvents {
        #[allow(missing_docs)]
        log(log),
        #[allow(missing_docs)]
    ...
    impl BaseAttestationDocVerifierTestEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BaseAttestationDocVerifierTestEvents {
        const NAME: &'static str = "BaseAttestationDocVerifierTestEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BaseAttestationDocVerifierTestEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::log(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BaseAttestationDocVerifierTest`](self) contract instance.

See the [wrapper's documentation](`BaseAttestationDocVerifierTestInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> BaseAttestationDocVerifierTestInstance<P, N> {
        BaseAttestationDocVerifierTestInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BaseAttestationDocVerifierTestInstance<P, N>>,
    > {
        BaseAttestationDocVerifierTestInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        BaseAttestationDocVerifierTestInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`BaseAttestationDocVerifierTest`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`BaseAttestationDocVerifierTest`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BaseAttestationDocVerifierTestInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BaseAttestationDocVerifierTestInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BaseAttestationDocVerifierTestInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<BaseAttestationDocVerifierTestInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> BaseAttestationDocVerifierTestInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(
            self,
        ) -> BaseAttestationDocVerifierTestInstance<P, N> {
            BaseAttestationDocVerifierTestInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }

        ...
        impl alloy_sol_types::SolCall for depositERC20Call {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: depositERC20Return = r.into();
                        r._0
                    })
            }
            #[inline]
            ...
            ) -> alloy_sol_types::Result<IArbBridgeCalls>] = &[
                {
                    fn sendContractTransaction(
                        ...
                        <sendContractTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IArbBridgeCalls::sendContractTransaction)
                    }
                ...
                },
                {
                    fn depositERC20(
                        ...
                        <depositERC20Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IArbBridgeCalls::depositERC20)
                    }
                    depositERC20
                },
            ];
...
See the [wrapper's documentation](`IArbBridgeInstance`) for more details.*/
    ...
    >(
        ...
        IArbBridgeInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IArbBridgeInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IArbBridgeInstance::<P, N>::deploy_builder(provider)
    }

...
```*/
    ...
    ///Container for all the [`IArbBridge`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IArbBridgeCalls {
        #[allow(missing_docs)]
        unsafeCreateRetryableTicket(unsafeCreateRetryableTicketCall),
    }
    impl IArbBridgeCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IArbBridgeCalls {
        const NAME: &'static str = "IArbBridgeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IArbBridgeCalls>] = &[
                {
                    fn unsafeCreateRetryableTicket(
                        ...
                        <unsafeCreateRetryableTicketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IArbBridgeCalls::unsafeCreateRetryableTicket)
                    }
    ...
    /**Creates a new wrapper around an on-chain [`IArbBridge`](self) contract instance.

See the [wrapper's documentation](`IArbBridgeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IArbBridgeInstance<P, N> {
        IArbBridgeInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IArbBridgeInstance<P, N>>,
    > {
        IArbBridgeInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IArbBridgeInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IArbBridge`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IArbBridge`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IArbBridgeInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IArbBridgeInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IArbBridgeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IArbBridgeInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IArbBridgeInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IArbBridgeInstance<P, N> {
            IArbBridgeInstance {

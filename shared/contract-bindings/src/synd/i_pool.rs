...
See the [wrapper's documentation](`IPoolInstance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, __provider: P) -> IPoolInstance<P, N> {
        IPoolInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IPoolInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IPoolInstance::<P, N>::deploy_builder(__provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IPoolInstance<P, N>> {

...
See the [wrapper's documentation](`IAccessControlEnumerableInstance`) for more details.*/
    ...
    >(
        ...
        IAccessControlEnumerableInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IAccessControlEnumerableInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IAccessControlEnumerableInstance::<P, N>::deploy_builder(provider)
    }

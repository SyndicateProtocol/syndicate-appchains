...
```*/
    ...
    impl IOneStepProofEntryCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(getStartMachineHash),
            ::core::stringify!(proveOneStep),
            ::core::stringify!(getEndMachineHash),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <getStartMachineHashCall as alloy_sol_types::SolCall>::SIGNATURE,
            <proveOneStepCall as alloy_sol_types::SolCall>::SIGNATURE,
            <getEndMachineHashCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`IOneStepProofEntryInstance`) for more details.*/
    ...
    >(
        ...
        IOneStepProofEntryInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IOneStepProofEntryInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IOneStepProofEntryInstance::<P, N>::deploy_builder(__provider)
    }

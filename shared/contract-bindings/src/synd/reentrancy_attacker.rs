...
```*/
    ...
    impl ReentrancyAttackerCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(attack)];
...
See the [wrapper's documentation](`ReentrancyAttackerInstance`) for more details.*/
    ...
    >(
        ...
        ReentrancyAttackerInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ReentrancyAttackerInstance::<P, N>::deploy(__provider, _target)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        ReentrancyAttackerInstance::<P, N>::deploy_builder(__provider, _target)
    }

...
```*/
                ...
                },
                {
                    fn START_TIMESTAMP(
                        ...
                        <START_TIMESTAMPCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(EpochTrackerCalls::START_TIMESTAMP)
                    }
                    START_TIMESTAMP
                },
                {
    ...
    ///Container for all the [`EpochTracker`](self) custom errors.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum EpochTrackerErrors {
        #[allow(missing_docs)]
        ZeroEpochIndex(ZeroEpochIndex),
    }
    #[automatically_derived]
    impl EpochTrackerErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for EpochTrackerErrors {
        const NAME: &'static str = "EpochTrackerErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<EpochTrackerErrors>] = &[
                {
                    fn ZeroEpochIndex(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<EpochTrackerErrors> {
                        <ZeroEpochIndex as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(EpochTrackerErrors::ZeroEpochIndex)
                    }
                    ZeroEpochIndex
                },
            ];
...
See the [wrapper's documentation](`EpochTrackerInstance`) for more details.*/
    ...
    >(
        ...
        EpochTrackerInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        EpochTrackerInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        EpochTrackerInstance::<P, N>::deploy_builder(__provider)
    }

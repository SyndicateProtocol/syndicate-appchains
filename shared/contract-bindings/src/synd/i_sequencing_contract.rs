...
```*/
    ...
    ///Container for all the [`ISequencingContract`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ISequencingContractCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ISequencingContractCalls {
        const NAME: &'static str = "ISequencingContractCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ISequencingContractCalls>] = &[
                {
                    fn getEmissionsReceiver(
                        ...
                        <getEmissionsReceiverCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISequencingContractCalls::getEmissionsReceiver)
                    }
                ...
                },
                {
                    fn getTokensForEpoch(
                        ...
                        <getTokensForEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISequencingContractCalls::getTokensForEpoch)
                    }
                    getTokensForEpoch
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ISequencingContract`](self) contract instance.

See the [wrapper's documentation](`ISequencingContractInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ISequencingContractInstance<P, N> {
        ISequencingContractInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISequencingContractInstance<P, N>>,
    > {
        ISequencingContractInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISequencingContractInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`ISequencingContract`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ISequencingContract`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ISequencingContractInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISequencingContractInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ISequencingContractInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ISequencingContractInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ISequencingContractInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISequencingContractInstance<P, N> {
            ISequencingContractInstance {

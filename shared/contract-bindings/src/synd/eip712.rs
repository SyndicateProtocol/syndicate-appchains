...
```*/
    ...
    impl alloy_sol_types::SolInterface for EIP712Errors {
        const NAME: &'static str = "EIP712Errors";
        const MIN_DATA_LENGTH: usize = 0usize;
    ...
    impl alloy_sol_types::SolEventInterface for EIP712Events {
        const NAME: &'static str = "EIP712Events";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for EIP712Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
See the [wrapper's documentation](`EIP712Instance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, provider: P) -> EIP712Instance<P, N> {
        EIP712Instance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        EIP712Instance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        EIP712Instance::<P, N>::deploy_builder(provider)
    }

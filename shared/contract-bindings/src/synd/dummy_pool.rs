...
```*/
    ...
    ///Container for all the [`DummyPool`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum DummyPoolCalls {
        #[allow(missing_docs)]
        deposit(depositCall),
    }
    #[automatically_derived]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for DummyPoolCalls {
        const NAME: &'static str = "DummyPoolCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<DummyPoolCalls>] = &[
                {
                    fn deposit(data: &[u8]) -> alloy_sol_types::Result<DummyPoolCalls> {
                        <depositCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(DummyPoolCalls::deposit)
                    }
                    deposit
                },
            ];
    ...
    ///Container for all the [`DummyPool`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum DummyPoolEvents {
        #[allow(missing_docs)]
        Deposit(Deposit),
    }
    #[automatically_derived]
    impl DummyPoolEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for DummyPoolEvents {
        const NAME: &'static str = "DummyPoolEvents";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for DummyPoolEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Deposit(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`DummyPool`](self) contract instance.

See the [wrapper's documentation](`DummyPoolInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> DummyPoolInstance<P, N> {
        DummyPoolInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<DummyPoolInstance<P, N>>,
    > {
        DummyPoolInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        DummyPoolInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`DummyPool`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`DummyPool`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct DummyPoolInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for DummyPoolInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("DummyPoolInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<DummyPoolInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> DummyPoolInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> DummyPoolInstance<P, N> {
            DummyPoolInstance {

...
```*/
    ...
    impl SafeERC20Errors {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(SafeERC20FailedDecreaseAllowance),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <SafeERC20FailedOperation as alloy_sol_types::SolError>::SIGNATURE,
            <SafeERC20FailedDecreaseAllowance as alloy_sol_types::SolError>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`SafeERC20Instance`) for more details.*/
    ...
    >(
        ...
        SafeERC20Instance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        SafeERC20Instance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        SafeERC20Instance::<P, N>::deploy_builder(__provider)
    }

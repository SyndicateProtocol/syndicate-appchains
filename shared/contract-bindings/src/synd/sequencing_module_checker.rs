                ...
                },
                {
                    fn BatchSizeExceedsMaximum(
                        ...
                        <BatchSizeExceedsMaximum as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(SequencingModuleCheckerErrors::BatchSizeExceedsMaximum)
                    }
...
See the [wrapper's documentation](`SequencingModuleCheckerInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> SequencingModuleCheckerInstance<P, N> {
        SequencingModuleCheckerInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<SequencingModuleCheckerInstance<P, N>>,
    > {
        SequencingModuleCheckerInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        SequencingModuleCheckerInstance::<P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for SequencingModuleCheckerInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<SequencingModuleCheckerInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> SequencingModuleCheckerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> SequencingModuleCheckerInstance<P, N> {

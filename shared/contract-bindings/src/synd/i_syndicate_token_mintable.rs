...
See the [wrapper's documentation](`ISyndicateTokenMintableInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> ISyndicateTokenMintableInstance<P, N> {
        ISyndicateTokenMintableInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ISyndicateTokenMintableInstance<P, N>>,
    > {
        ISyndicateTokenMintableInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISyndicateTokenMintableInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISyndicateTokenMintableInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ISyndicateTokenMintableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ISyndicateTokenMintableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ISyndicateTokenMintableInstance<P, N> {

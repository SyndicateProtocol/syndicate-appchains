...
```*/
    ...
    impl RequireCompositeModuleFactoryCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(createRequireCompositeModule),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <createRequireCompositeModuleCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl RequireCompositeModuleFactoryEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(RequireCompositeModuleCreated),
        ...
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <RequireCompositeModuleCreated as alloy_sol_types::SolEvent>::SIGNATURE,
...
See the [wrapper's documentation](`RequireCompositeModuleFactoryInstance`) for more details.*/
    ...
    >(
        ...
        RequireCompositeModuleFactoryInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        RequireCompositeModuleFactoryInstance::<P, N>::deploy(__provider, admin)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        RequireCompositeModuleFactoryInstance::<P, N>::deploy_builder(__provider, admin)
    }

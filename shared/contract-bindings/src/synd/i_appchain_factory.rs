...
```*/
    ...
    ///Container for all the [`IAppchainFactory`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IAppchainFactoryCalls {
        #[allow(missing_docs)]
        getProxyBytecode(getProxyBytecodeCall),
    }
    #[automatically_derived]
    impl IAppchainFactoryCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IAppchainFactoryCalls {
        const NAME: &'static str = "IAppchainFactoryCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IAppchainFactoryCalls>] = &[
                {
                    fn getProxyBytecode(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IAppchainFactoryCalls> {
                        <getProxyBytecodeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAppchainFactoryCalls::getProxyBytecode)
                    }
                    getProxyBytecode
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IAppchainFactory`](self) contract instance.

See the [wrapper's documentation](`IAppchainFactoryInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IAppchainFactoryInstance<P, N> {
        IAppchainFactoryInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IAppchainFactoryInstance<P, N>>,
    > {
        IAppchainFactoryInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IAppchainFactoryInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IAppchainFactory`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IAppchainFactory`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IAppchainFactoryInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IAppchainFactoryInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IAppchainFactoryInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IAppchainFactoryInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IAppchainFactoryInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IAppchainFactoryInstance<P, N> {
            IAppchainFactoryInstance {

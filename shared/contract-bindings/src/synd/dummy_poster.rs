...
```*/
    ...
    impl DummyPosterCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(sendRoot),
            ::core::stringify!(postAssertion),
            ::core::stringify!(blockHash),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <sendRootCall as alloy_sol_types::SolCall>::SIGNATURE,
            <postAssertionCall as alloy_sol_types::SolCall>::SIGNATURE,
            <blockHashCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`DummyPosterInstance`) for more details.*/
    ...
    >(
        ...
        DummyPosterInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        DummyPosterInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        DummyPosterInstance::<P, N>::deploy_builder(__provider)
    }

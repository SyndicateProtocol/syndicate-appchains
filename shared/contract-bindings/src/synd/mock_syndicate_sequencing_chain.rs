...
```*/
    ...
    impl MockSyndicateSequencingChainCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(setRevertFlag),
            ::core::stringify!(processTransaction),
            ::core::stringify!(lastProcessedBulkData),
            ...
            ::core::stringify!(lastProcessedData),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <setRevertFlagCall as alloy_sol_types::SolCall>::SIGNATURE,
            <processTransactionCall as alloy_sol_types::SolCall>::SIGNATURE,
            <lastProcessedBulkDataCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <lastProcessedDataCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];

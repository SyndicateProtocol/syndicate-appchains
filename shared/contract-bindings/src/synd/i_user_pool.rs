...
```*/
    ...
    ///Container for all the [`IUserPool`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IUserPoolCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IUserPoolCalls {
        const NAME: &'static str = "IUserPoolCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IUserPoolCalls>] = &[
                {
                    fn claimFor(data: &[u8]) -> alloy_sol_types::Result<IUserPoolCalls> {
                        <claimForCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IUserPoolCalls::claimFor)
                    }
                    claimFor
                },
                {
                    fn getClaimableAmount(
                        ...
                        <getClaimableAmountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUserPoolCalls::getClaimableAmount)
                    }
                    getClaimableAmount
                },
                {
                    fn deposit(data: &[u8]) -> alloy_sol_types::Result<IUserPoolCalls> {
                        <depositCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IUserPoolCalls::deposit)
                    }
                    deposit
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IUserPool`](self) contract instance.

See the [wrapper's documentation](`IUserPoolInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IUserPoolInstance<P, N> {
        IUserPoolInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUserPoolInstance<P, N>>,
    > {
        IUserPoolInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IUserPoolInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IUserPool`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IUserPool`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUserPoolInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IUserPoolInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IUserPoolInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUserPoolInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IUserPoolInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUserPoolInstance<P, N> {
            IUserPoolInstance {

    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for EXECUTOR_ROLECall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: EXECUTOR_ROLEReturn = r.into();
                        r._0
                    })
            }
            #[inline]
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<IUpgradeExecutorCalls>] = &[
                {
                    fn EXECUTOR_ROLE(
                        ...
                        <EXECUTOR_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IUpgradeExecutorCalls::EXECUTOR_ROLE)
                    }
...
See the [wrapper's documentation](`IUpgradeExecutorInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> IUpgradeExecutorInstance<P, N> {
        IUpgradeExecutorInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUpgradeExecutorInstance<P, N>>,
    > {
        IUpgradeExecutorInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IUpgradeExecutorInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUpgradeExecutorInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IUpgradeExecutorInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IUpgradeExecutorInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IUpgradeExecutorInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUpgradeExecutorInstance<P, N> {
    ...
    > IUpgradeExecutorInstance<P, N> {
        ...
        pub fn EXECUTOR_ROLE(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, EXECUTOR_ROLECall, N> {

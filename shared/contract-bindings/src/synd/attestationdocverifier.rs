    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for expirationToleranceCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = expirationToleranceReturn;
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for syndCommitHashCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = syndCommitHashReturn;
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > AttestationDocVerifierInstance<T, P, N> {
        ...
        pub fn expirationTolerance(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, expirationToleranceCall, N> {
        ...
        pub fn syndCommitHash(
            &self,
        ) -> alloy_contract::SolCallBuilder<T, &P, syndCommitHashCall, N> {

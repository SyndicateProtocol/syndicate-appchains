...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ReentrantContractInstance::<P, N>::deploy(__provider, _staking, _pool)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        ReentrantContractInstance::<P, N>::deploy_builder(__provider, _staking, _pool)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            ...
            let call_builder = Self::deploy_builder(__provider, _staking, _pool);

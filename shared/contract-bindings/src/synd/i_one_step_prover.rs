...
```*/
    ...
    const _: () = {
        ...
        impl executeOneStepReturn {
            fn _tokenize(
                &self,
            ) -> <executeOneStepCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                (
                    <Machine as alloy_sol_types::SolType>::tokenize(&self.result),
                    <Module as alloy_sol_types::SolType>::tokenize(&self.resultMod),
                )
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for executeOneStepCall {
            ...
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                executeOneStepReturn::_tokenize(ret)
            }
            #[inline]
    ...
    impl IOneStepProverCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(executeOneStep),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <executeOneStepCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<IOneStepProverCalls>] = &[
                {
                    fn executeOneStep(
                        ...
                        <executeOneStepCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOneStepProverCalls::executeOneStep)
                    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IOneStepProverInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IOneStepProverInstance<P, N> {
        #[inline]
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IOneStepProverInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IOneStepProverInstance<P, N> {
    ...
    > IOneStepProverInstance<P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, executeOneStepCall, N> {
            self.call_builder(
                &executeOneStepCall {
                    execCtx,
                    mach,

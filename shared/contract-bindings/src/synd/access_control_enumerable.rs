...
See the [wrapper's documentation](`AccessControlEnumerableInstance`) for more details.*/
    ...
    >(
        ...
        AccessControlEnumerableInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AccessControlEnumerableInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AccessControlEnumerableInstance::<P, N>::deploy_builder(provider)
    }

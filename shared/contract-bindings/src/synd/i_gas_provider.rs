...
```*/
    ...
    ///Container for all the [`IGasProvider`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IGasProviderCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IGasProviderCalls {
        const NAME: &'static str = "IGasProviderCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IGasProviderCalls>] = &[
                {
                    fn getAppchainGasFees(
                        ...
                        <getAppchainGasFeesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IGasProviderCalls::getAppchainGasFees)
                    }
                    getAppchainGasFees
                },
                {
                    fn getActiveAppchainIds(
                        ...
                        <getActiveAppchainIdsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IGasProviderCalls::getActiveAppchainIds)
                    }
                ...
                },
                {
                    fn getTotalGasFees(
                        ...
                        <getTotalGasFeesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IGasProviderCalls::getTotalGasFees)
                    }
                    getTotalGasFees
                },
                {
                    fn getAppchainRewardsReceiver(
                        ...
                        <getAppchainRewardsReceiverCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IGasProviderCalls::getAppchainRewardsReceiver)
                    }
    ...
    /**Creates a new wrapper around an on-chain [`IGasProvider`](self) contract instance.

See the [wrapper's documentation](`IGasProviderInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IGasProviderInstance<P, N> {
        IGasProviderInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IGasProviderInstance<P, N>>,
    > {
        IGasProviderInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IGasProviderInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IGasProvider`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IGasProvider`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IGasProviderInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IGasProviderInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IGasProviderInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IGasProviderInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IGasProviderInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IGasProviderInstance<P, N> {
            IGasProviderInstance {

            ...
            ) -> alloy_sol_types::Result<ISyndStakingCalls>] = &[
                {
                    fn getEpochStart(
                        ...
                        <getEpochStartCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISyndStakingCalls::getEpochStart)
                    }
                    getEpochStart
                },
                {
                ...
                },
                {
                    fn getCurrentEpoch(
                        ...
                        <getCurrentEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISyndStakingCalls::getCurrentEpoch)
                    }
                    getCurrentEpoch
                },
                {
                ...
                },
                {
                    fn getEpochEnd(
                        ...
                        <getEpochEndCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ISyndStakingCalls::getEpochEnd)
                    }
                    getEpochEnd
                },
                {
...
See the [wrapper's documentation](`ISyndStakingInstance`) for more details.*/
    ...
    >(
        ...
        ISyndStakingInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ISyndStakingInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISyndStakingInstance::<P, N>::deploy_builder(__provider)
    }

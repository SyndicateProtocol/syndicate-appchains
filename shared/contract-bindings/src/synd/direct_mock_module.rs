...
```*/
    ...
    impl DirectMockModuleCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(allowedData),
            ::core::stringify!(setAllowed),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <isAllowedCall as alloy_sol_types::SolCall>::SIGNATURE,
            <allowedDataCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setAllowedCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`DirectMockModuleInstance`) for more details.*/
    ...
    >(
        ...
        DirectMockModuleInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        DirectMockModuleInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        DirectMockModuleInstance::<P, N>::deploy_builder(__provider)
    }

...
See the [wrapper's documentation](`AllowlistSequencingModuleTestInstance`) for more details.*/
    ...
    >(
        ...
        AllowlistSequencingModuleTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AllowlistSequencingModuleTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AllowlistSequencingModuleTestInstance::<P, N>::deploy_builder(provider)
    }

...
```*/
    ...
    impl NoncesCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(nonces)];
...
See the [wrapper's documentation](`NoncesInstance`) for more details.*/
    ...
    >(
        ...
        NoncesInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        NoncesInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        NoncesInstance::<P, N>::deploy_builder(__provider)
    }

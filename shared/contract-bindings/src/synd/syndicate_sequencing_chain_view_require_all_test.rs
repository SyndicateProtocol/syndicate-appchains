...
```*/
    ...
    impl SyndicateSequencingChainViewRequireAllTestCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(testGetAllRequirementsRequireAll),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <testGetAllRequirementsRequireAllCall as alloy_sol_types::SolCall>::SIGNATURE,
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        >,
    > {
        SyndicateSequencingChainViewRequireAllTestInstance::<P, N>::deploy(__provider)
    }

...
```*/
    ...
    ///Container for all the [`ERC20Votes`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20VotesCalls {
        const NAME: &'static str = "ERC20VotesCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ERC20VotesCalls>] = &[
                {
                    fn name(data: &[u8]) -> alloy_sol_types::Result<ERC20VotesCalls> {
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::name)
                    }
                    name
                },
                {
                    fn approve(data: &[u8]) -> alloy_sol_types::Result<ERC20VotesCalls> {
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                ...
                },
                {
                    fn getPastVotes(
                        ...
                        <getPastVotesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::getPastVotes)
                    }
                    getPastVotes
                },
                {
                    fn CLOCK_MODE(
                        ...
                        <CLOCK_MODECall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::CLOCK_MODE)
                    }
                    CLOCK_MODE
                },
                {
                ...
                },
                {
                    fn numCheckpoints(
                        ...
                        <numCheckpointsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::numCheckpoints)
                    }
                    numCheckpoints
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn nonces(data: &[u8]) -> alloy_sol_types::Result<ERC20VotesCalls> {
                        <noncesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::nonces)
                    }
                    nonces
                },
                {
                    fn eip712Domain(
                        ...
                        <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::eip712Domain)
                    }
                    eip712Domain
                },
                {
                    fn getPastTotalSupply(
                        ...
                        <getPastTotalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::getPastTotalSupply)
                    }
                    getPastTotalSupply
                },
                {
                    fn clock(data: &[u8]) -> alloy_sol_types::Result<ERC20VotesCalls> {
                        <clockCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::clock)
                    }
                    clock
                },
                {
                    fn symbol(data: &[u8]) -> alloy_sol_types::Result<ERC20VotesCalls> {
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20VotesCalls::symbol)
                    }
                    symbol
                },
                {
                ...
                },
                {
                    fn delegateBySig(
                        ...
                        <delegateBySigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::delegateBySig)
                    }
                    delegateBySig
                },
                {
                ...
                },
                {
                    fn checkpoints(
                        ...
                        <checkpointsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20VotesCalls::checkpoints)
                    }
                    checkpoints
                },
            ];
    ...
    ///Container for all the [`ERC20Votes`](self) custom errors.
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20VotesErrors {
        const NAME: &'static str = "ERC20VotesErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ERC20VotesErrors>] = &[
                {
                    fn ERC20ExceededSafeSupply(
                        ...
                        <ERC20ExceededSafeSupply as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20ExceededSafeSupply)
                    }
                ...
                },
                {
                    fn CheckpointUnorderedInsertion(
                        ...
                        <CheckpointUnorderedInsertion as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::CheckpointUnorderedInsertion)
                    }
                ...
                },
                {
                    fn StringTooLong(
                        ...
                        <StringTooLong as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::StringTooLong)
                    }
                    StringTooLong
                },
                {
                    fn VotesExpiredSignature(
                        ...
                        <VotesExpiredSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::VotesExpiredSignature)
                    }
                ...
                },
                {
                    fn SafeCastOverflowedUintDowncast(
                        ...
                        <SafeCastOverflowedUintDowncast as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::SafeCastOverflowedUintDowncast)
                    }
                ...
                },
                {
                    fn ERC6372InconsistentClock(
                        ...
                        <ERC6372InconsistentClock as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC6372InconsistentClock)
                    }
                ...
                },
                {
                    fn InvalidAccountNonce(
                        ...
                        <InvalidAccountNonce as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::InvalidAccountNonce)
                    }
                    InvalidAccountNonce
                },
                {
                    fn ERC20InvalidSpender(
                        ...
                        <ERC20InvalidSpender as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InvalidSpender)
                    }
                    ERC20InvalidSpender
                },
                {
                    fn ERC20InvalidSender(
                        ...
                        <ERC20InvalidSender as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InvalidSender)
                    }
                    ERC20InvalidSender
                },
                {
                    fn InvalidShortString(
                        ...
                        <InvalidShortString as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::InvalidShortString)
                    }
                    InvalidShortString
                },
                {
                    fn ECDSAInvalidSignatureS(
                        ...
                        <ECDSAInvalidSignatureS as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ECDSAInvalidSignatureS)
                    }
                ...
                },
                {
                    fn ERC20InsufficientBalance(
                        ...
                        <ERC20InsufficientBalance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InsufficientBalance)
                    }
                ...
                },
                {
                    fn ERC20InvalidApprover(
                        ...
                        <ERC20InvalidApprover as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InvalidApprover)
                    }
                ...
                },
                {
                    fn ERC20InvalidReceiver(
                        ...
                        <ERC20InvalidReceiver as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InvalidReceiver)
                    }
                ...
                },
                {
                    fn ERC5805FutureLookup(
                        ...
                        <ERC5805FutureLookup as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC5805FutureLookup)
                    }
                    ERC5805FutureLookup
                },
                {
                    fn ECDSAInvalidSignature(
                        ...
                        <ECDSAInvalidSignature as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ECDSAInvalidSignature)
                    }
                ...
                },
                {
                    fn ERC20InsufficientAllowance(
                        ...
                        <ERC20InsufficientAllowance as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ERC20InsufficientAllowance)
                    }
                ...
                },
                {
                    fn ECDSAInvalidSignatureLength(
                        ...
                        <ECDSAInvalidSignatureLength as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(ERC20VotesErrors::ECDSAInvalidSignatureLength)
                    }
    ...
    ///Container for all the [`ERC20Votes`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC20VotesEvents {
        const NAME: &'static str = "ERC20VotesEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC20VotesEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`ERC20Votes`](self) contract instance.

See the [wrapper's documentation](`ERC20VotesInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> ERC20VotesInstance<P, N> {
        ERC20VotesInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC20VotesInstance<P, N>>,
    > {
        ERC20VotesInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ERC20VotesInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ERC20Votes`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC20Votes`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC20VotesInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ERC20VotesInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20VotesInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ERC20VotesInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ERC20VotesInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC20VotesInstance<P, N> {
            ERC20VotesInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,

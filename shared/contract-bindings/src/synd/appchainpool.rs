...
See the [wrapper's documentation](`AppchainPoolInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> AppchainPoolInstance<T, P, N> {
        AppchainPoolInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<AppchainPoolInstance<T, P, N>>,
    > {
        AppchainPoolInstance::<T, P, N>::deploy(provider, _stakingContract)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        AppchainPoolInstance::<T, P, N>::deploy_builder(provider, _stakingContract)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct AppchainPoolInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for AppchainPoolInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
            _stakingContract: alloy::sol_types::private::Address,
        ) -> alloy_contract::Result<AppchainPoolInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> AppchainPoolInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> AppchainPoolInstance<T, P, N> {

...
```*/
    ...
    impl MockFactoryCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(isImplementationAllowed),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <notifyChainUpgradeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <isImplementationAllowedCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
...
See the [wrapper's documentation](`MockFactoryInstance`) for more details.*/
    ...
    >(
        ...
        MockFactoryInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        MockFactoryInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MockFactoryInstance::<P, N>::deploy_builder(__provider)
    }

...
pub mod MockAppchainFactory {
    ...
    ///
    /// ```text
    ///0x608080604052346013576003908160188239f35b5f80fdfe5f80fd
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80\x80`@R4`\x13W`\x03\x90\x81`\x18\x829\xF3[_\x80\xFD\xFE_\x80\xFD",
    );
...
See the [wrapper's documentation](`MockAppchainFactoryInstance`) for more details.*/
    ...
    >(
        ...
        MockAppchainFactoryInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        MockAppchainFactoryInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MockAppchainFactoryInstance::<P, N>::deploy_builder(__provider)
    }

...
```*/
    ...
    ///Container for all the [`ILegacyAppchain`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ILegacyAppchainCalls {
        #[allow(missing_docs)]
        getTokensForEpoch(getTokensForEpochCall),
    }
    impl ILegacyAppchainCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[224u8, 57u8, 97u8, 102u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ILegacyAppchainCalls {
        const NAME: &'static str = "ILegacyAppchainCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ILegacyAppchainCalls>] = &[
                {
                    fn getTokensForEpoch(
                        ...
                        <getTokensForEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ILegacyAppchainCalls::getTokensForEpoch)
                    }
                    getTokensForEpoch
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ILegacyAppchain`](self) contract instance.

See the [wrapper's documentation](`ILegacyAppchainInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ILegacyAppchainInstance<P, N> {
        ILegacyAppchainInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ILegacyAppchainInstance<P, N>>,
    > {
        ILegacyAppchainInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ILegacyAppchainInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ILegacyAppchain`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ILegacyAppchain`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ILegacyAppchainInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ILegacyAppchainInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ILegacyAppchainInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ILegacyAppchainInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ILegacyAppchainInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ILegacyAppchainInstance<P, N> {
            ILegacyAppchainInstance {

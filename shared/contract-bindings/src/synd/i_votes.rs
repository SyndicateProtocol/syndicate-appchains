...
```*/
    ...
    ///Container for all the [`IVotes`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IVotesCalls {
        const NAME: &'static str = "IVotesCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IVotesCalls>] = &[
                {
                    fn getPastVotes(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IVotesCalls> {
                        <getPastVotesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(IVotesCalls::getPastVotes)
                    }
                    getPastVotes
                },
                {
                    fn delegates(data: &[u8]) -> alloy_sol_types::Result<IVotesCalls> {
                        <delegatesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IVotesCalls::delegates)
                    }
                    delegates
                },
                {
                    fn delegate(data: &[u8]) -> alloy_sol_types::Result<IVotesCalls> {
                        <delegateCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IVotesCalls::delegate)
                    }
                    delegate
                },
                {
                    fn getPastTotalSupply(
                        ...
                        <getPastTotalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IVotesCalls::getPastTotalSupply)
                    }
                    getPastTotalSupply
                },
                {
                    fn getVotes(data: &[u8]) -> alloy_sol_types::Result<IVotesCalls> {
                        <getVotesCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IVotesCalls::getVotes)
                    }
                    getVotes
                },
                {
    ...
    ///Container for all the [`IVotes`](self) custom errors.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum IVotesErrors {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IVotesErrors {
        const NAME: &'static str = "IVotesErrors";
        const MIN_DATA_LENGTH: usize = 32usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IVotesErrors>] = &[
                {
                    fn VotesExpiredSignature(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IVotesErrors> {
                        <VotesExpiredSignature as alloy_sol_types::SolError>::abi_decode_raw(
                                data,
                            )
                            .map(IVotesErrors::VotesExpiredSignature)
                    }
    ...
    ///Container for all the [`IVotes`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IVotesEvents {
        const NAME: &'static str = "IVotesEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IVotesEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IVotes`](self) contract instance.

See the [wrapper's documentation](`IVotesInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(address: alloy_sol_types::private::Address, provider: P) -> IVotesInstance<P, N> {
        IVotesInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IVotesInstance<P, N>>,
    > {
        IVotesInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IVotesInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IVotes`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IVotes`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IVotesInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IVotesInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IVotesInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IVotesInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IVotesInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IVotesInstance<P, N> {
            IVotesInstance {

...
See the [wrapper's documentation](`AttestationDocVerifierPlonkTestInstance`) for more details.*/
    ...
    >(
        ...
        AttestationDocVerifierPlonkTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AttestationDocVerifierPlonkTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AttestationDocVerifierPlonkTestInstance::<P, N>::deploy_builder(provider)
    }

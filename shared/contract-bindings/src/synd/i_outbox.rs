    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for OutBoxTransactionExecuted {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                32u8, 175u8, 127u8, 59u8, 191u8, 227u8, 129u8, 50u8, 184u8, 144u8, 10u8,
                226u8, 149u8, 205u8, 156u8, 141u8, 25u8, 20u8, 190u8, 112u8, 82u8, 208u8,
                97u8, 165u8, 17u8, 243u8, 247u8, 40u8, 218u8, 177u8, 137u8, 100u8,
            ]);
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for SendRootUpdated {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                180u8, 223u8, 56u8, 71u8, 48u8, 15u8, 7u8, 106u8, 54u8, 156u8, 215u8,
                109u8, 35u8, 20u8, 180u8, 112u8, 161u8, 25u8, 77u8, 158u8, 138u8, 107u8,
                185u8, 127u8, 24u8, 96u8, 174u8, 232u8, 138u8, 95u8, 103u8, 72u8,
            ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
        ...
        impl alloy_sol_types::SolCall for OUTBOX_VERSIONCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: OUTBOX_VERSIONReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for calculateItemHashCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: calculateItemHashReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for calculateMerkleRootCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: calculateMerkleRootReturn = r.into();
                        r._0
                    })
            }
            #[inline]
...
```*/
    ...
    const _: () = {
        ...
        impl executeTransactionReturn {
            fn _tokenize(
                &self,
            ) -> <executeTransactionCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for executeTransactionCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                executeTransactionReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl executeTransactionSimulationReturn {
            fn _tokenize(
                &self,
            ) -> <executeTransactionSimulationCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for executeTransactionSimulationCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                executeTransactionSimulationReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for l2ToL1BlockCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: l2ToL1BlockReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for l2ToL1EthBlockCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: l2ToL1EthBlockReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for l2ToL1OutputIdCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: l2ToL1OutputIdReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for l2ToL1SenderCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: l2ToL1SenderReturn = r.into();
                        r._0
                    })
            }
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for l2ToL1TimestampCall {
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                ...
                > as alloy_sol_types::SolType>::abi_decode_sequence(data)
                    .map(|r| {
                        let r: l2ToL1TimestampReturn = r.into();
                        r._0
                    })
            }
            #[inline]
...
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct rootsCall(pub alloy::sol_types::private::FixedBytes<32>);
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
...
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct spentCall(pub alloy::sol_types::private::primitives::aliases::U256);
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
...
```*/
    ...
    const _: () = {
        ...
        impl updateSendRootReturn {
            fn _tokenize(
                &self,
            ) -> <updateSendRootCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for updateSendRootCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                updateSendRootReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    impl IOutboxCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(calculateMerkleRoot),
            ::core::stringify!(executeTransaction),
            ::core::stringify!(executeTransactionSimulation),
            ::core::stringify!(l2ToL1Block),
            ::core::stringify!(isSpent),
            ::core::stringify!(updateRollupAddress),
            ::core::stringify!(l2ToL1OutputId),
            ::core::stringify!(l2ToL1Sender),
            ::core::stringify!(l2ToL1EthBlock),
            ::core::stringify!(postUpgradeInit),
            ::core::stringify!(calculateItemHash),
            ::core::stringify!(updateSendRoot),
            ::core::stringify!(roots),
            ::core::stringify!(l2ToL1Timestamp),
            ::core::stringify!(initialize),
            ::core::stringify!(OUTBOX_VERSION),
            ::core::stringify!(rollup),
            ::core::stringify!(spent),
            ::core::stringify!(bridge),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <calculateMerkleRootCall as alloy_sol_types::SolCall>::SIGNATURE,
            <executeTransactionCall as alloy_sol_types::SolCall>::SIGNATURE,
            <executeTransactionSimulationCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2ToL1BlockCall as alloy_sol_types::SolCall>::SIGNATURE,
            <isSpentCall as alloy_sol_types::SolCall>::SIGNATURE,
            <updateRollupAddressCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2ToL1OutputIdCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2ToL1SenderCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2ToL1EthBlockCall as alloy_sol_types::SolCall>::SIGNATURE,
            <postUpgradeInitCall as alloy_sol_types::SolCall>::SIGNATURE,
            <calculateItemHashCall as alloy_sol_types::SolCall>::SIGNATURE,
            <updateSendRootCall as alloy_sol_types::SolCall>::SIGNATURE,
            <rootsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <l2ToL1TimestampCall as alloy_sol_types::SolCall>::SIGNATURE,
            <initializeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <OUTBOX_VERSIONCall as alloy_sol_types::SolCall>::SIGNATURE,
            <rollupCall as alloy_sol_types::SolCall>::SIGNATURE,
            <spentCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl alloy_sol_types::SolInterface for IOutboxCalls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IOutboxCalls>] = &[
                {
                ...
                {
                    fn isSpent(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <isSpentCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn roots(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <rootsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn initialize(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                ...
                {
                    fn rollup(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                ...
                {
                    fn spent(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <spentCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IOutboxCalls::spent)
                    }
                    spent
                },
                {
                    fn bridge(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<IOutboxCalls>] = &[
                {
                    fn calculateMerkleRoot(
                        ...
                        <calculateMerkleRootCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::calculateMerkleRoot)
                    }
                ...
                },
                {
                    fn executeTransaction(
                        ...
                        <executeTransactionCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::executeTransaction)
                    }
                ...
                },
                {
                    fn executeTransactionSimulation(
                        ...
                        <executeTransactionSimulationCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::executeTransactionSimulation)
                    }
                ...
                },
                {
                    fn l2ToL1Block(
                        ...
                        <l2ToL1BlockCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::l2ToL1Block)
                    }
                ...
                {
                    fn isSpent(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <isSpentCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::isSpent)
                    }
                ...
                },
                {
                    fn l2ToL1OutputId(
                        ...
                        <l2ToL1OutputIdCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::l2ToL1OutputId)
                    }
                ...
                },
                {
                    fn l2ToL1Sender(
                        ...
                        <l2ToL1SenderCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::l2ToL1Sender)
                    }
                ...
                },
                {
                    fn l2ToL1EthBlock(
                        ...
                        <l2ToL1EthBlockCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::l2ToL1EthBlock)
                    }
                ...
                },
                {
                    fn calculateItemHash(
                        ...
                        <calculateItemHashCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::calculateItemHash)
                    }
                ...
                },
                {
                    fn updateSendRoot(
                        ...
                        <updateSendRootCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::updateSendRoot)
                    }
                ...
                {
                    fn roots(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <rootsCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::roots)
                    }
                ...
                },
                {
                    fn l2ToL1Timestamp(
                        ...
                        <l2ToL1TimestampCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::l2ToL1Timestamp)
                    }
                ...
                },
                {
                    fn OUTBOX_VERSION(
                        ...
                        <OUTBOX_VERSIONCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::OUTBOX_VERSION)
                    }
                ...
                {
                    fn spent(data: &[u8]) -> alloy_sol_types::Result<IOutboxCalls> {
                        <spentCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IOutboxCalls::spent)
                    }
    ...
    impl IOutboxEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(OutBoxTransactionExecuted),
            ::core::stringify!(SendRootUpdated),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <OutBoxTransactionExecuted as alloy_sol_types::SolEvent>::SIGNATURE,
            <SendRootUpdated as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
...
See the [wrapper's documentation](`IOutboxInstance`) for more details.*/
    ...
    >(
        ...
        IOutboxInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IOutboxInstance<P, N>>,
    > {
        IOutboxInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IOutboxInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IOutboxInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IOutboxInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IOutboxInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IOutboxInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IOutboxInstance<P, N> {
            IOutboxInstance {
    ...
    > IOutboxInstance<P, N> {
        ...
        pub fn OUTBOX_VERSION(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, OUTBOX_VERSIONCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, calculateItemHashCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, calculateMerkleRootCall, N> {
            self.call_builder(
        ...
        pub fn executeTransaction(
            ...
            value: alloy::sol_types::private::primitives::aliases::U256,
            data: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, executeTransactionCall, N> {
            self.call_builder(
        ...
        pub fn executeTransactionSimulation(
            ...
            value: alloy::sol_types::private::primitives::aliases::U256,
            data: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, executeTransactionSimulationCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, rootsCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, spentCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, updateSendRootCall, N> {
            self.call_builder(
                &updateSendRootCall {
                    sendRoot,
                    l2BlockHash,
    ...
    > IOutboxInstance<P, N> {
        ...
        pub fn OutBoxTransactionExecuted_filter(
            &self,
        ) -> alloy_contract::Event<&P, OutBoxTransactionExecuted, N> {
        ...
        pub fn SendRootUpdated_filter(
            &self,
        ) -> alloy_contract::Event<&P, SendRootUpdated, N> {

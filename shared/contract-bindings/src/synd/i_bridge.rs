...
```*/
    ...
    impl IBridgeCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(allowedOutboxes),
            ::core::stringify!(setDelayedInbox),
            ::core::stringify!(setSequencerInbox),
            ::core::stringify!(sequencerReportedSubMessageCount),
            ::core::stringify!(submitBatchSpendingReport),
            ::core::stringify!(enqueueSequencerMessage),
            ::core::stringify!(updateRollupAddress),
            ::core::stringify!(allowedOutboxList),
            ::core::stringify!(executeCall),
            ::core::stringify!(activeOutbox),
            ::core::stringify!(allowedDelayedInboxes),
            ::core::stringify!(rollup),
            ::core::stringify!(setOutbox),
            ::core::stringify!(delayedInboxAccs),
            ::core::stringify!(allowedDelayedInboxList),
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <allowedOutboxesCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setDelayedInboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setSequencerInboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <sequencerReportedSubMessageCountCall as alloy_sol_types::SolCall>::SIGNATURE,
            <submitBatchSpendingReportCall as alloy_sol_types::SolCall>::SIGNATURE,
            <enqueueSequencerMessageCall as alloy_sol_types::SolCall>::SIGNATURE,
            <updateRollupAddressCall as alloy_sol_types::SolCall>::SIGNATURE,
            <allowedOutboxListCall as alloy_sol_types::SolCall>::SIGNATURE,
            <executeCallCall as alloy_sol_types::SolCall>::SIGNATURE,
            <activeOutboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <allowedDelayedInboxesCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <allowedDelayedInboxListCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl IBridgeEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(BridgeCallTriggered),
            ::core::stringify!(OutboxToggle),
            ::core::stringify!(MessageDelivered),
            ::core::stringify!(InboxToggle),
            ::core::stringify!(SequencerInboxUpdated),
            ::core::stringify!(RollupUpdated),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <BridgeCallTriggered as alloy_sol_types::SolEvent>::SIGNATURE,
            <OutboxToggle as alloy_sol_types::SolEvent>::SIGNATURE,
            <MessageDelivered as alloy_sol_types::SolEvent>::SIGNATURE,
            <InboxToggle as alloy_sol_types::SolEvent>::SIGNATURE,
            <SequencerInboxUpdated as alloy_sol_types::SolEvent>::SIGNATURE,
            <RollupUpdated as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(

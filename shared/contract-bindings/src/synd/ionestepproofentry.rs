    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for getEndMachineHashCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = getEndMachineHashReturn;
...
See the [wrapper's documentation](`IOneStepProofEntryInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> IOneStepProofEntryInstance<T, P, N> {
        IOneStepProofEntryInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IOneStepProofEntryInstance<T, P, N>>,
    > {
        IOneStepProofEntryInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IOneStepProofEntryInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IOneStepProofEntryInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IOneStepProofEntryInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IOneStepProofEntryInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IOneStepProofEntryInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IOneStepProofEntryInstance<T, P, N> {
    ...
    > IOneStepProofEntryInstance<T, P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<T, &P, getEndMachineHashCall, N> {
            self.call_builder(

...
```*/
    ...
    impl CheckpointsErrors {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[37u8, 32u8, 96u8, 29u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for CheckpointsErrors {
        const NAME: &'static str = "CheckpointsErrors";
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        CheckpointsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        CheckpointsInstance::<P, N>::deploy_builder(__provider)
    }

...
See the [wrapper's documentation](`PanicInstance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, __provider: P) -> PanicInstance<P, N> {
        PanicInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        PanicInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        PanicInstance::<P, N>::deploy_builder(__provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<PanicInstance<P, N>> {

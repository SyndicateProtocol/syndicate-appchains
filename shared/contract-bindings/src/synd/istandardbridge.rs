...
```*/
    ...
    ///Container for all the [`IStandardBridge`](self) function calls.
    pub enum IStandardBridgeCalls {
        #[allow(missing_docs)]
        bridgeERC20To(bridgeERC20ToCall),
    }
    #[automatically_derived]
    impl IStandardBridgeCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[84u8, 10u8, 191u8, 115u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IStandardBridgeCalls {
        const NAME: &'static str = "IStandardBridgeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IStandardBridgeCalls>] = &[
                {
                    fn bridgeERC20To(
                        data: &[u8],
                        validate: bool,
                        ...
                        <bridgeERC20ToCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IStandardBridgeCalls::bridgeERC20To)
                    }
                    bridgeERC20To
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IStandardBridge`](self) contract instance.

See the [wrapper's documentation](`IStandardBridgeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IStandardBridgeInstance<T, P, N> {
        IStandardBridgeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IStandardBridgeInstance<T, P, N>>,
    > {
        IStandardBridgeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IStandardBridgeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IStandardBridge`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IStandardBridge`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IStandardBridgeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IStandardBridgeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IStandardBridgeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IStandardBridgeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IStandardBridgeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IStandardBridgeInstance<T, P, N> {
            IStandardBridgeInstance {

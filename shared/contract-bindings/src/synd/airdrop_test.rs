...
```*/
    ...
    impl AirdropTestCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(test_RevertWhen_AirdropERC20_InsufficientAllowance),
            ::core::stringify!(recipient2),
            ::core::stringify!(minter),
            ::core::stringify!(setUp),
            ::core::stringify!(INITIAL_BALANCE),
            ::core::stringify!(testFuzz_AirdropERC20_ValidInputs),
            ::core::stringify!(test_RevertWhen_AirdropERC20_ArrayLengthMismatch),
            ::core::stringify!(excludeSenders),
            ::core::stringify!(targetInterfaces),
            ::core::stringify!(test_AirdropERC20_MultipleRecipients),
            ::core::stringify!(test_AirdropERC20_ZeroAmounts),
            ::core::stringify!(airdrop),
            ::core::stringify!(test_RevertWhen_AirdropERC20_InsufficientBalance),
            ::core::stringify!(targetSenders),
            ::core::stringify!(targetContracts),
            ::core::stringify!(recipient3),
            ::core::stringify!(test_Invariant_TokenBalanceConservation),
            ::core::stringify!(test_AirdropERC20_GasEfficiency_LargeBatch),
            ::core::stringify!(test_AirdropERC20_EqualAmounts),
            ::core::stringify!(targetArtifactSelectors),
            ::core::stringify!(test_AirdropERC20_MaxRecipients),
            ::core::stringify!(test_RevertWhen_AirdropERC20_EmptyArrays),
            ::core::stringify!(targetArtifacts),
            ::core::stringify!(test_AirdropERC20_GasEfficiency_SmallBatch),
            ::core::stringify!(targetSelectors),
            ::core::stringify!(test_AirdropERC20_Integration_MultipleAirdrops),
            ::core::stringify!(recipient1),
            ::core::stringify!(test_AirdropERC20_TotalAmountMismatch_StillWorks),
            ::core::stringify!(excludeSelectors),
            ::core::stringify!(excludeArtifacts),
            ::core::stringify!(failed),
            ::core::stringify!(test_AirdropERC20_DuplicateRecipients),
            ::core::stringify!(airdropper),
            ::core::stringify!(excludeContracts),
            ::core::stringify!(test_AirdropERC20_SingleRecipient),
            ::core::stringify!(admin),
            ::core::stringify!(IS_TEST),
            ::core::stringify!(recipient4),
            ::core::stringify!(token),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <test_RevertWhen_AirdropERC20_InsufficientAllowanceCall as alloy_sol_types::SolCall>::SIGNATURE,
            <recipient2Call as alloy_sol_types::SolCall>::SIGNATURE,
            <minterCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setUpCall as alloy_sol_types::SolCall>::SIGNATURE,
            <INITIAL_BALANCECall as alloy_sol_types::SolCall>::SIGNATURE,
            <testFuzz_AirdropERC20_ValidInputsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_RevertWhen_AirdropERC20_ArrayLengthMismatchCall as alloy_sol_types::SolCall>::SIGNATURE,
            <excludeSendersCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetInterfacesCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_MultipleRecipientsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_ZeroAmountsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <airdropCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_RevertWhen_AirdropERC20_InsufficientBalanceCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetSendersCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetContractsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <recipient3Call as alloy_sol_types::SolCall>::SIGNATURE,
            <test_Invariant_TokenBalanceConservationCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_GasEfficiency_LargeBatchCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_EqualAmountsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_MaxRecipientsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_RevertWhen_AirdropERC20_EmptyArraysCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetArtifactsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_GasEfficiency_SmallBatchCall as alloy_sol_types::SolCall>::SIGNATURE,
            <targetSelectorsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_Integration_MultipleAirdropsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <recipient1Call as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_TotalAmountMismatch_StillWorksCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <test_AirdropERC20_DuplicateRecipientsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <airdropperCall as alloy_sol_types::SolCall>::SIGNATURE,
            <excludeContractsCall as alloy_sol_types::SolCall>::SIGNATURE,
            <test_AirdropERC20_SingleRecipientCall as alloy_sol_types::SolCall>::SIGNATURE,
            <adminCall as alloy_sol_types::SolCall>::SIGNATURE,
            <IS_TESTCall as alloy_sol_types::SolCall>::SIGNATURE,
            <recipient4Call as alloy_sol_types::SolCall>::SIGNATURE,
...
See the [wrapper's documentation](`AirdropTestInstance`) for more details.*/
    ...
    >(
        ...
        AirdropTestInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        AirdropTestInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        AirdropTestInstance::<P, N>::deploy_builder(__provider)
    }

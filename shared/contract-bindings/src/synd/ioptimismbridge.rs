...
```*/
    ...
    ///Container for all the [`IOptimismBridge`](self) function calls.
    pub enum IOptimismBridgeCalls {
        #[allow(missing_docs)]
        depositERC20To(depositERC20ToCall),
    }
    #[automatically_derived]
    impl IOptimismBridgeCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[131u8, 139u8, 37u8, 32u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IOptimismBridgeCalls {
        const NAME: &'static str = "IOptimismBridgeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IOptimismBridgeCalls>] = &[
                {
                    fn depositERC20To(
                        data: &[u8],
                        validate: bool,
                        ...
                        <depositERC20ToCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IOptimismBridgeCalls::depositERC20To)
                    }
                    depositERC20To
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IOptimismBridge`](self) contract instance.

See the [wrapper's documentation](`IOptimismBridgeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IOptimismBridgeInstance<T, P, N> {
        IOptimismBridgeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IOptimismBridgeInstance<T, P, N>>,
    > {
        IOptimismBridgeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IOptimismBridgeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IOptimismBridge`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IOptimismBridge`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IOptimismBridgeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IOptimismBridgeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IOptimismBridgeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IOptimismBridgeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IOptimismBridgeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IOptimismBridgeInstance<T, P, N> {
            IOptimismBridgeInstance {

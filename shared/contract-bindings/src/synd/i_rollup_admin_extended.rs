...
See the [wrapper's documentation](`ISequencerInboxInstance`) for more details.*/
    ...
    >(
        ...
        ISequencerInboxInstance::<P, N>::new(address, __provider)
    }
...
```*/
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolStruct for Config {
            ...
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "Config(uint64 confirmPeriodBlocks,uint64 extraChallengeTimeBlocks,address stakeToken,uint256 baseStake,bytes32 wasmModuleRoot,address owner,address loserStakeEscrow,uint256 chainId,string chainConfig,uint64 genesisBlockNum,MaxTimeVariation sequencerInboxMaxTimeVariation)",
                )
            }
            #[inline]
            fn eip712_components() -> alloy_sol_types::private::Vec<
...
```*/
    ...
    const _: () = {
        ...
        impl forceResolveChallengeReturn {
            fn _tokenize(
                &self,
            ) -> <forceResolveChallengeCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for forceResolveChallengeCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                forceResolveChallengeReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl setExtraChallengeTimeBlocksReturn {
            fn _tokenize(
                &self,
            ) -> <setExtraChallengeTimeBlocksCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for setExtraChallengeTimeBlocksCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                setExtraChallengeTimeBlocksReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl setStakeTokenReturn {
            fn _tokenize(
                &self,
            ) -> <setStakeTokenCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for setStakeTokenCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                setStakeTokenReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl upgradeBeaconReturn {
            fn _tokenize(
                &self,
            ) -> <upgradeBeaconCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for upgradeBeaconCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                upgradeBeaconReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    impl IRollupAdminExtendedCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(setStakeToken),
            ::core::stringify!(resume),
            ::core::stringify!(setBaseStake),
            ...
            ::core::stringify!(setDelayedInbox),
            ::core::stringify!(setSequencerInbox),
            ::core::stringify!(removeOldOutbox),
            ::core::stringify!(paused),
            ::core::stringify!(setExtraChallengeTimeBlocks),
            ::core::stringify!(forceRefundStaker),
            ::core::stringify!(pause),
            ::core::stringify!(upgradeBeacon),
            ::core::stringify!(setWasmModuleRoot),
            ::core::stringify!(setMinimumAssertionPeriod),
            ::core::stringify!(setValidatorWhitelistDisabled),
            ::core::stringify!(setValidator),
            ::core::stringify!(setConfirmPeriodBlocks),
            ::core::stringify!(setValidatorAfkBlocks),
            ::core::stringify!(forceResolveChallenge),
            ::core::stringify!(setLoserStakeEscrow),
            ::core::stringify!(setOutbox),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <setStakeTokenCall as alloy_sol_types::SolCall>::SIGNATURE,
            <resumeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setBaseStakeCall as alloy_sol_types::SolCall>::SIGNATURE,
            ...
            <setDelayedInboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setSequencerInboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <removeOldOutboxCall as alloy_sol_types::SolCall>::SIGNATURE,
            <pausedCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setExtraChallengeTimeBlocksCall as alloy_sol_types::SolCall>::SIGNATURE,
            <forceRefundStakerCall as alloy_sol_types::SolCall>::SIGNATURE,
            <pauseCall as alloy_sol_types::SolCall>::SIGNATURE,
            <upgradeBeaconCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setWasmModuleRootCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setMinimumAssertionPeriodCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setValidatorWhitelistDisabledCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setValidatorCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setConfirmPeriodBlocksCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setValidatorAfkBlocksCall as alloy_sol_types::SolCall>::SIGNATURE,
            <forceResolveChallengeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setLoserStakeEscrowCall as alloy_sol_types::SolCall>::SIGNATURE,
            <setOutboxCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
            ...
            ) -> alloy_sol_types::Result<IRollupAdminExtendedCalls>] = &[
                {
                    fn setStakeToken(
                        ...
                        <setStakeTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::setStakeToken)
                    }
                    setStakeToken
                },
                {
                ...
                },
                {
                    fn forceConfirmNode(
                        ...
                        <forceConfirmNodeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::forceConfirmNode)
                    }
                    forceConfirmNode
                },
                {
                    fn forceCreateNode(
                        ...
                        <forceCreateNodeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::forceCreateNode)
                    }
                    forceCreateNode
                },
                {
                ...
                },
                {
                    fn setExtraChallengeTimeBlocks(
                        ...
                        <setExtraChallengeTimeBlocksCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::setExtraChallengeTimeBlocks)
                    }
                ...
                },
                {
                    fn upgradeBeacon(
                        ...
                        <upgradeBeaconCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::upgradeBeacon)
                    }
                    upgradeBeacon
                },
                {
                ...
                },
                {
                    fn forceResolveChallenge(
                        ...
                        <forceResolveChallengeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IRollupAdminExtendedCalls::forceResolveChallenge)
                    }
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<IRollupAdminExtendedCalls>] = &[
                {
                    fn setStakeToken(
                        ...
                        <setStakeTokenCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IRollupAdminExtendedCalls::setStakeToken)
                    }
                ...
                },
                {
                    fn setExtraChallengeTimeBlocks(
                        ...
                        <setExtraChallengeTimeBlocksCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IRollupAdminExtendedCalls::setExtraChallengeTimeBlocks)
                    }
                ...
                },
                {
                    fn upgradeBeacon(
                        ...
                        <upgradeBeaconCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IRollupAdminExtendedCalls::upgradeBeacon)
                    }
                ...
                },
                {
                    fn forceResolveChallenge(
                        ...
                        <forceResolveChallengeCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IRollupAdminExtendedCalls::forceResolveChallenge)
                    }
    ...
    impl IRollupAdminExtendedEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(OwnerFunctionCalled),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <OwnerFunctionCalled as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
...
See the [wrapper's documentation](`IRollupAdminExtendedInstance`) for more details.*/
    ...
    >(
        ...
        IRollupAdminExtendedInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        IRollupAdminExtendedInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IRollupAdminExtendedInstance::<P, N>::deploy_builder(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > IRollupAdminExtendedInstance<P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, forceResolveChallengeCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, setExtraChallengeTimeBlocksCall, N> {
            self.call_builder(
        ...
        ) -> alloy_contract::SolCallBuilder<&P, setStakeTokenCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, upgradeBeaconCall, N> {
            self.call_builder(
                &upgradeBeaconCall {
                    beacon,
                    newImplementation,

...
See the [wrapper's documentation](`TestnetSyndTokenTestInstance`) for more details.*/
    ...
    >(
        ...
        TestnetSyndTokenTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        TestnetSyndTokenTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        TestnetSyndTokenTestInstance::<P, N>::deploy_builder(provider)
    }

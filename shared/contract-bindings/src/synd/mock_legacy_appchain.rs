...
pub mod MockLegacyAppchain {
    ...
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80\x80`@R4`\x13W`\xB6\x90\x81`\x18\x829\xF3[_\x80\xFD\xFE`\x80\x80`@R`\x046\x10\x15`\x11W_\x80\xFD[_5`\xE0\x1C\x90\x81c\x0Cg#c\x14`uWPc\xDB0\x06\x01\x14`/W_\x80\xFD[4`qW`@\x7F\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC6\x01\x12`qW`\x045_R_` R`$5`@_ U_\x80\xF3[_\x80\xFD[4`qW` \x7F\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC6\x01\x12`qW` \x90`\x045_R_\x82R`@_ T\x81R\xF3",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80\x80`@R`\x046\x10\x15`\x11W_\x80\xFD[_5`\xE0\x1C\x90\x81c\x0Cg#c\x14`uWPc\xDB0\x06\x01\x14`/W_\x80\xFD[4`qW`@\x7F\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC6\x01\x12`qW`\x045_R_` R`$5`@_ U_\x80\xF3[_\x80\xFD[4`qW` \x7F\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFC6\x01\x12`qW` \x90`\x045_R_\x82R`@_ T\x81R\xF3",
    );
            ...
            ) -> alloy_sol_types::Result<MockLegacyAppchainCalls>] = &[
                {
                    fn tokensUsedPerEpoch(
                        ...
                        <tokensUsedPerEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(MockLegacyAppchainCalls::tokensUsedPerEpoch)
                    }
                    tokensUsedPerEpoch
                },
                {

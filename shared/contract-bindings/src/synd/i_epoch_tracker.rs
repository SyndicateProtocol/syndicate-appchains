...
```*/
    ...
    ///Container for all the [`IEpochTracker`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IEpochTrackerCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IEpochTrackerCalls {
        const NAME: &'static str = "IEpochTrackerCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IEpochTrackerCalls>] = &[
                {
                    fn getEpochStart(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IEpochTrackerCalls> {
                        <getEpochStartCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochTrackerCalls::getEpochStart)
                    }
                    getEpochStart
                },
                {
                    fn getCurrentEpoch(
                        ...
                        <getCurrentEpochCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochTrackerCalls::getCurrentEpoch)
                    }
                    getCurrentEpoch
                },
                {
                    fn getEpochEnd(
                        ...
                        <getEpochEndCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IEpochTrackerCalls::getEpochEnd)
                    }
                    getEpochEnd
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IEpochTracker`](self) contract instance.

See the [wrapper's documentation](`IEpochTrackerInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IEpochTrackerInstance<P, N> {
        IEpochTrackerInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IEpochTrackerInstance<P, N>>,
    > {
        IEpochTrackerInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IEpochTrackerInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IEpochTracker`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IEpochTracker`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IEpochTrackerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IEpochTrackerInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IEpochTrackerInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IEpochTrackerInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IEpochTrackerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEpochTrackerInstance<P, N> {

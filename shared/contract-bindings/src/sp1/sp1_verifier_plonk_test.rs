...
```*/
    ...
    const _: () = {
        ...
        impl test_RevertVerifyProof_WhenPlonkReturn {
            fn _tokenize(
                &self,
            ) -> <test_RevertVerifyProof_WhenPlonkCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for test_RevertVerifyProof_WhenPlonkCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                test_RevertVerifyProof_WhenPlonkReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl test_VerifyProof_WhenPlonkReturn {
            fn _tokenize(
                &self,
            ) -> <test_VerifyProof_WhenPlonkCall as alloy_sol_types::SolCall>::ReturnToken<
                '_,
            > {
                ()
            }
        ...
        impl alloy_sol_types::SolCall for test_VerifyProof_WhenPlonkCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                test_VerifyProof_WhenPlonkReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                },
                {
                    fn test_VerifyProof_WhenPlonk(
                        ...
                        <test_VerifyProof_WhenPlonkCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(SP1VerifierPlonkTestCalls::test_VerifyProof_WhenPlonk)
                    }
                ...
                },
                {
                    fn test_RevertVerifyProof_WhenPlonk(
                        ...
                        <test_RevertVerifyProof_WhenPlonkCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(
                                SP1VerifierPlonkTestCalls::test_RevertVerifyProof_WhenPlonk,
...
See the [wrapper's documentation](`SP1VerifierPlonkTestInstance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> SP1VerifierPlonkTestInstance<P, N> {
        SP1VerifierPlonkTestInstance::<P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<SP1VerifierPlonkTestInstance<P, N>>,
    > {
        SP1VerifierPlonkTestInstance::<P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        SP1VerifierPlonkTestInstance::<P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct SP1VerifierPlonkTestInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for SP1VerifierPlonkTestInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<SP1VerifierPlonkTestInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> SP1VerifierPlonkTestInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> SP1VerifierPlonkTestInstance<P, N> {
    ...
    > SP1VerifierPlonkTestInstance<P, N> {
        ...
        pub fn test_RevertVerifyProof_WhenPlonk(
            ...
            N,
        > {
            self.call_builder(&test_RevertVerifyProof_WhenPlonkCall)
        }
        ///Creates a new call builder for the [`test_VerifyProof_WhenPlonk`] function.
        pub fn test_VerifyProof_WhenPlonk(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, test_VerifyProof_WhenPlonkCall, N> {

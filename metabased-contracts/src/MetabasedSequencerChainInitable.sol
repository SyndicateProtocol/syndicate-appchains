...
import {SequencingModuleCheckerInitable} from "./SequencingModuleCheckerInitable.sol";
...
contract MetabasedSequencerChainInitable is SequencingModuleCheckerInitable {
    ...
    constructor(uint256 _l3ChainId) SequencingModuleCheckerInitable() {

 ...
 */
library AddressStructuredLinkedList_ReleaseCandidate {
     ...
     * @param self stored linked list from contract
     * @return address the head of the list
     */
     ...
     * @return bool, address, address true if node exists or false otherwise, previous node, next node
     */
     ...
     * @return bool, address true if node exists or false otherwise, node in _direction
     */
    function getAdjacent(List storage self, address _node, bool _direction) internal view returns (bool, address) {
        if (!nodeExists(self, _node)) {
            return (false, address(0));
        } else {
            address adjacent = self.list[_node][_direction];
     ...
     * @param self stored linked list from contract
     * @param _node id of the node to step from
     * @return bool, address true if node exists or false otherwise, next node
     */
     ...
     * @param self stored linked list from contract
     * @param _node id of the node to step from
     * @return bool, address true if node exists or false otherwise, previous node
     */
     ...
     * @return address the removed node
     */

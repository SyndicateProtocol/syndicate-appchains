...
abstract contract SequencingModuleChecker is Ownable, PermissionModule {
    ...
    PermissionModule public requirementChainModule;
    ...
    constructor(address admin, address _requirementChainModule) Ownable(admin) {
        ...
        requirementChainModule = PermissionModule(_requirementChainModule);
    }
    ...
    function updateMasterModule(address _newModule) external onlyOwner {
        ...
        requirementChainModule = PermissionModule(_newModule);

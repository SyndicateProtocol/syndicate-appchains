...
type Config struct {
	SettlementChainURL         string `koanf:"settlement_chain_url"`
	SequencingChainURL         string `koanf:"sequencing_chain_url"`
	MetaBasedChainURL          string `koanf:"meta_based_chain_url"`
...
func setCLIFlags(f *pflag.FlagSet) {
	...
	f.String("settlement_chain_url", "https://sepolia.base.org", "Settlement chain address")
	f.String("sequencing_chain_url", "https://sepolia.base.org", "Sequencing chain address")
	f.String("meta_based_chain_url", "https://sepolia.base.org", "Meta based chain address")
...
func hydrateFromConfMap(config *Config) {
	...
	config.SettlementChainURL = k.String("settlement_chain_url")
	config.SequencingChainURL = k.String("sequencing_chain_url")
	config.MetaBasedChainURL = k.String("meta_based_chain_url")
